...
export const metadata: Metadata = {
  title: 'Paver Installation in Castro Valley, CA | TP Pavers',
  description:
    'Professional paver installation in Castro Valley, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Castro Valley neighborhoods.',
  keywords: [
    'pavers castro valley',
    'castro valley pavers',
    'paver installation castro valley',
    'paver contractor castro valley',
    'driveway pavers castro valley ca',
    'patio pavers castro valley',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers castro valley',
    'retaining wall castro valley',
    'hardscape castro valley ca',
  ],
  openGraph: {
    title: 'Paver Installation in Castro Valley, CA | TP Pavers',
    description:
      'Expert paver installation in Castro Valley. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Castro Valley, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Castro Valley | TP Pavers',
    description: 'Expert paver installation in Castro Valley, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/castro-valley',
  },
};
...
const services = [
  {
    ...
    description:
      'Upgrade your Castro Valley home with a custom interlocking paver driveway. From the scenic streets of Five Canyons to the elegant properties of Palomares Hills, our driveways are built to handle daily traffic and elevate your curb appeal.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Castro Valley\'s warm Mediterranean climate. Whether you\'re near Crow Canyon or in the Jensen Ranch area, we create beautiful backyard patios and front walkways that last decades.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Castro Valley\'s rolling hills and canyon terrain in neighborhoods like Five Canyons and Palomares Hills demand expert structural solutions. Our retaining walls prevent erosion, create usable tiered landscapes, and add lasting value.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Castro Valley lawn green year-round. Our premium artificial turf is perfect for families and pets in neighborhoods from Proctor to Greenridge, ideal for California\'s drought-conscious lifestyle.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Castro Valley, CA?',
    answer:
      'Paver installation costs in Castro Valley depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway in Five Canyons or a patio in Jensen Ranch, we provide free on-site estimates with transparent pricing. Most Castro Valley homeowners find pavers offer excellent long-term value compared to poured concrete.',
  },
  {
    question: 'What neighborhoods in Castro Valley do you serve?',
    answer:
      'We serve all of Castro Valley including Five Canyons, Palomares Hills, Proctor, Jensen Ranch, Crow Canyon, and Greenridge. We also cover neighboring cities like Hayward, San Leandro, Dublin, and Pleasanton.',
  },
  {
    question: 'How long does a paver driveway installation take in Castro Valley?',
    answer:
      'Most residential paver projects in Castro Valley — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Castro Valley\'s climate?',
    answer:
      'Castro Valley enjoys a mild Mediterranean climate with warm, dry summers and cool, wet winters. Concrete pavers and natural stone are excellent choices — both are durable, slip-resistant when sealed, and low-maintenance. We help you select materials that perform beautifully in the East Bay climate.',
  },
  {
    question: 'Do you offer a warranty on Castro Valley paver installations?',
    answer:
      'Yes. Every paver installation in Castro Valley comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for every project.',
  },
  {
    question: 'Can you build retaining walls on Castro Valley\'s hillside properties?',
    answer:
      'Absolutely. Castro Valley\'s hilly terrain — especially in Five Canyons, Palomares Hills, and the Crow Canyon corridor — often requires retaining walls. We design and build structural walls that prevent erosion, add usable yard space, and complement your landscape beautifully.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Castro Valley"
            afterAlt="Backyard after paver installation in Castro Valley - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Castro Valley, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN CASTRO VALLEY
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Castro Valley Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Castro Valley is a charming unincorporated community nestled in the East Bay hills, known for its family-friendly neighborhoods, scenic canyons, and homeowners who take pride in their properties. From the upscale homes of Five Canyons to the established neighborhoods of Proctor and Jensen Ranch, we design hardscapes that complement your home and enhance your outdoor living.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Castro Valley, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Hayward, San Leandro, Dublin, Pleasanton &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Castro Valley — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Castro Valley Home?
          </h2>
