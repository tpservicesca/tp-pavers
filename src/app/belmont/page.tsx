...
export const metadata: Metadata = {
  title: 'Paver Installation in Belmont, CA | TP Pavers',
  description:
    'Professional paver installation in Belmont, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Belmont neighborhoods.',
  keywords: [
    'pavers belmont',
    'belmont pavers',
    'paver installation belmont',
    'paver contractor belmont',
    'driveway pavers belmont ca',
    'patio pavers belmont',
    'belmont paver contractor',
    'pavers in belmont ca',
    'retaining wall belmont',
    'hardscape belmont ca',
    'paver driveway belmont california',
    'outdoor pavers belmont',
  ],
  openGraph: {
    title: 'Paver Installation in Belmont, CA | TP Pavers',
    description:
      'Expert paver installation in Belmont. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/belmont',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Belmont, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Belmont | TP Pavers',
    description: 'Expert paver installation in Belmont, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/belmont',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Belmont',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Belmont, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/belmont',
...
const services = [
  {
    ...
    description:
      'Elevate your Belmont home with a custom interlocking paver driveway. Designed to complement the hillside charm of neighborhoods like Belmont Hills and Carlmont while handling everyday traffic with ease.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Create stunning outdoor living areas that take advantage of Belmont&apos;s mild Peninsula climate. From intimate patios in Sterling Downs to expansive walkways in Hallmark, we bring your vision to life.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Belmont&apos;s hillside terrain makes retaining walls essential for many properties. Our expertly engineered walls prevent erosion, create usable yard space, and add beauty to sloped lots throughout Belmont Hills and Homeview.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Keep your Belmont lawn lush and green year-round without the water bill. Our premium synthetic turf is ideal for families and pets, and perfectly suited to California&apos;s water-conscious lifestyle.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Belmont, CA?',
    answer:
      'Paver installation costs in Belmont vary based on project scope, materials selected, and site preparation requirements. Whether you need a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Belmont homeowners find pavers offer excellent long-term value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Belmont do you serve?',
    answer:
      'We serve all Belmont neighborhoods including Belmont Hills, Hallmark, Homeview, Belmont Village, Sterling Downs, and Carlmont. We also cover neighboring cities like San Carlos, Redwood City, and San Mateo.',
  },
  {
    question: 'How long does a paver driveway installation take in Belmont?',
    answer:
      'Most residential paver projects in Belmont are completed within 1 to 2 weeks depending on size and complexity. We manage the entire process from demolition to final sealing. After your free consultation, we provide a detailed project timeline.',
  },
  {
    question: 'Are pavers a good choice for Belmont&apos;s hillside properties?',
    answer:
      'Absolutely. Pavers are an excellent choice for Belmont&apos;s hilly terrain. They provide superior drainage, flexibility on slopes, and can be combined with retaining walls for a complete hillside solution. We have extensive experience working on sloped lots throughout the Belmont Hills area.',
  },
  {
    question: 'Do you offer a warranty on Belmont paver installations?',
    answer:
      'Yes. Every paver installation in Belmont comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Belmont?',
    answer:
      'Yes, we handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is critical for lasting results, and we never cut corners — especially on Belmont&apos;s hillside properties where drainage is key.',
  },
];

const neighborhoods = ['Belmont Hills', 'Hallmark', 'Homeview', 'Belmont Village', 'Sterling Downs', 'Carlmont'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Belmont"
            afterAlt="Backyard after paver installation in Belmont - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Belmont, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN BELMONT
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Belmont Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Nestled between the rolling hills and the San Francisco Bay, Belmont is a picturesque Peninsula community known for its hillside homes, excellent schools, and family-friendly neighborhoods. From the scenic slopes of Belmont Hills to the charming streets of Carlmont, we design hardscapes that complement this beautiful hillside city&apos;s unique character.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Belmont, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: San Carlos, Redwood City, San Mateo, Foster City &amp; surrounding Peninsula areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Belmont — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Belmont Home?
          </h2>
