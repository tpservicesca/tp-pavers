...
const services = [
  {
    ...
    description:
      'Upgrade your San Lorenzo home with a custom interlocking paver driveway. From Bohannon Manor to Hillside and throughout San Lorenzo Village, our driveways enhance curb appeal and withstand daily use with style.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for San Lorenzo\'s mild Bay Area climate. We create beautiful backyard patios and front walkways that extend your living space and are perfect for year-round entertaining.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'San Lorenzo properties benefit from expertly constructed retaining walls that define spaces, prevent erosion, and add elegant landscape tiers. We build structural and decorative walls that enhance your outdoor areas.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and enjoy a lush green lawn year-round in San Lorenzo. Our premium artificial turf is perfect for families and pets — a smart, eco-friendly choice for water-conscious California living.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Paver installation costs in San Lorenzo depend on the project size, materials chosen, and site preparation needed. We provide free on-site estimates with transparent pricing for driveways, patios, and walkways throughout San Lorenzo. Most homeowners find pavers an excellent value.',
  },
  {
  ...
  {
    question: 'How long does a paver patio installation take in San Lorenzo?',
    answer:
  ...
  },
  {
    ...
    answer:
      'San Lorenzo enjoys a mild Mediterranean climate with warm summers and cool winters. Concrete pavers and natural stone are excellent choices — both are durable, low-maintenance, and perform beautifully in the East Bay. We help you select the best materials for your project and budget.',
  },
  {
    question: 'Do you offer a warranty on San Lorenzo paver installations?',
    answer:
      'Yes. Every paver installation in San Lorenzo comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in San Lorenzo?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is essential for a lasting install, and we deliver beautiful, durable results for San Lorenzo homeowners.',
  },
];
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            San Lorenzo is a welcoming unincorporated community with a central location in Alameda County. From the established neighborhoods near Bohannon Manor to Hillside and San Lorenzo Village, we design hardscapes that enhance your property and create beautiful outdoor spaces for every home.
          </p>
