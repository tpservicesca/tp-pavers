...
export const metadata: Metadata = {
  title: 'Paver Installation in Alameda, CA | TP Pavers',
  description:
    'Professional paver installation in Alameda, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Alameda neighborhoods.',
  keywords: [
    'pavers alameda',
    'alameda pavers',
    'paver installation alameda',
    'paver contractor alameda',
    'driveway pavers alameda ca',
    'patio pavers alameda',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers alameda',
    'retaining wall alameda',
    'hardscape alameda ca',
  ],
  openGraph: {
    title: 'Paver Installation in Alameda, CA | TP Pavers',
    description:
      'Expert paver installation in Alameda. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/alameda',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Alameda, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Alameda | TP Pavers',
    description: 'Expert paver installation in Alameda, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/alameda',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Alameda',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Alameda, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/alameda',
...
const services = [
  {
    ...
    description:
      'Upgrade your Alameda home with a custom interlocking paver driveway. From the stately Victorian homes of the Gold Coast to the waterfront properties of South Shore, our driveways add lasting beauty and curb appeal to this charming island city.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Alameda\'s mild, sunny climate. Whether you\'re on Bay Farm Island or in the West End, we create beautiful patios and walkways that extend your living space and complement your home\'s character.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Alameda\'s unique island landscape benefits from well-designed retaining walls. We build structural and decorative walls that define outdoor spaces, add garden tiers, and enhance your property\'s functionality and beauty.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and enjoy a lush green lawn year-round in Alameda. Our premium artificial turf is perfect for families and pets across the island, from Central Alameda to Fernside — a smart choice for water-conscious island living.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Alameda, CA?',
    answer:
      'Paver installation costs in Alameda depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway on the Gold Coast or a patio on Bay Farm Island, we provide free on-site estimates with transparent pricing. Most Alameda homeowners find pavers a worthwhile investment in their island property.',
  },
  {
    question: 'What neighborhoods in Alameda do you serve?',
    answer:
      'We serve all of Alameda including West End, East End, Bay Farm Island, Gold Coast, South Shore, Fernside, and Central Alameda. We also cover neighboring cities like Oakland, San Leandro, and Berkeley.',
  },
  {
    question: 'How long does a paver patio installation take in Alameda?',
    answer:
      'Most residential paver projects in Alameda — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Every paver installation in Alameda comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you work on Bay Farm Island properties?',
    answer:
      'Yes, we serve all areas of Alameda including Bay Farm Island. We understand the unique considerations of island properties and deliver the same high-quality paver installations throughout the entire city of Alameda.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Alameda"
            afterAlt="Backyard after paver installation in Alameda - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Alameda, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN ALAMEDA
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Alameda Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Alameda is a beautiful island city known for its Victorian homes, tree-lined streets, and tight-knit community. From the historic Gold Coast to the modern developments on Bay Farm Island, we design hardscapes that honor your home\'s character and enhance your outdoor living spaces.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Alameda, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Oakland, San Leandro, Berkeley &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Alameda — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Alameda Home?
          </h2>
