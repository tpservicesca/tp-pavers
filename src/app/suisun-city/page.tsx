...
export const metadata: Metadata = {
  title: 'Paver Installation in Suisun City, CA | TP Pavers',
  description:
    'Professional paver installation in Suisun City, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving Downtown Waterfront, Lawler Ranch & all Suisun City neighborhoods.',
  keywords: [
    'pavers suisun city',
    'suisun city pavers',
    'paver installation suisun city',
    'paver contractor suisun city',
    'driveway pavers suisun city ca',
    'patio pavers suisun city',
    'suisun city paver contractor',
    'pavers in suisun city ca',
    'retaining wall suisun city',
    'hardscape suisun city ca',
    'paver driveway suisun city california',
    'outdoor pavers suisun city',
    'paver installation near me',
    'driveway pavers near me',
    'backyard pavers suisun city',
  ],
  openGraph: {
    title: 'Paver Installation in Suisun City, CA | TP Pavers',
    description:
      'Expert paver installation in Suisun City. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/suisun-city',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Suisun City, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Suisun City | TP Pavers',
    description: 'Expert paver installation in Suisun City, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/suisun-city',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Suisun City',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Suisun City, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/suisun-city',
...
const services = [
  {
    ...
    description:
      'Upgrade your Suisun City home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Lawler Ranch and Peterson Ranch.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Suisun City\'s warm climate. From waterfront patios near the marina to backyard retreats in Lawler Ranch, we create hardscapes that last.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Suisun City\'s varied terrain near the marshlands and newer developments often requires structural solutions. Our retaining walls prevent erosion and create beautiful landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Suisun City lawn green year-round. Our premium artificial turf is perfect for families, pets, and Solano County\'s warm climate.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Suisun City, CA?',
    answer:
      'Paver installation costs in Suisun City depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Suisun City homeowners find pavers an excellent long-term investment.',
  },
  {
    question: 'What neighborhoods in Suisun City do you serve?',
    answer:
      'We serve all of Suisun City including the Downtown Waterfront, Suisun Marina area, Lawler Ranch, and Peterson Ranch. We also cover neighboring cities like Fairfield, Vacaville, and the Travis AFB area.',
  },
  {
    question: 'How long does a paver driveway installation take in Suisun City?',
    answer:
      'Most residential paver projects in Suisun City — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Suisun City\'s climate?',
    answer:
      'Suisun City enjoys warm summers with cooling Delta breezes and mild winters. Concrete pavers and natural stone are excellent choices — both are heat-resistant, durable, and low-maintenance. We select materials that perform beautifully in the Suisun climate.',
  },
  {
    question: 'Do you offer a warranty on Suisun City paver installations?',
    answer:
      'Yes. Every paver installation in Suisun City comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can pavers handle Suisun City\'s waterfront conditions?',
    answer:
      'Absolutely. We\'re experienced with the unique conditions near the Suisun Marsh and waterfront areas. We use proper base preparation and drainage solutions to ensure your pavers stay level and beautiful, even in areas with higher moisture levels.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Suisun City"
            afterAlt="Backyard after paver installation in Suisun City - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Suisun City, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[4.5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION IN<br />SUISUN CITY
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Suisun City Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Suisun City is a hidden gem in Solano County — a charming waterfront community with a revitalized downtown, scenic marina, and growing family neighborhoods. From the walkable Downtown Waterfront to the newer developments of Lawler Ranch, we design hardscapes that enhance your home&apos;s beauty and value.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Suisun City, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Suisun City Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Fairfield, Vacaville, Travis AFB &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Suisun City — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Suisun City Home?
          </h2>
