...
export const metadata: Metadata = {
  title: 'Paver Installation in Moraga, CA | TP Pavers',
  description:
    'Professional paver installation in Moraga, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Moraga neighborhoods.',
  keywords: [
    'pavers moraga',
    'moraga pavers',
    'paver installation moraga',
    'paver contractor moraga',
    'driveway pavers moraga ca',
    'patio pavers moraga',
    'moraga paver contractor',
    'pavers in moraga ca',
    'retaining wall moraga',
    'hardscape moraga ca',
    'paver driveway moraga california',
    'outdoor pavers moraga',
  ],
  openGraph: {
    title: 'Paver Installation in Moraga, CA | TP Pavers',
    description:
      'Expert paver installation in Moraga. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/moraga',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Moraga, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Moraga | TP Pavers',
    description: 'Expert paver installation in Moraga, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/moraga',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Moraga',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Moraga, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/moraga',
...
const services = [
  {
    ...
    description:
      'Upgrade your Moraga home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Sanders Ranch and Campolindo.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Moraga\'s ranch-style properties and scenic valley neighborhoods. From backyard pavers to front walkways, we create durable patio paver designs for every Moraga home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Moraga\'s terrain near the rolling hills and valley terrain throughout Moraga often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Moraga lawn green year-round. Our premium artificial turf is perfect for families, pets, and Moraga\'s pleasant valley climate with warm summers and cool evenings.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in Moraga, CA?',
    answer:
      'Paver installation cost in Moraga depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Moraga homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Moraga do you serve?',
    answer:
      'We serve all of Moraga including Moraga Ranch, Campolindo, Sanders Ranch, Rheem Valley. We also cover neighboring cities like Lafayette, Orinda, Walnut Creek, Canyon and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Moraga?',
    answer:
      'Most residential paver projects in Moraga — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Moraga\'s climate?',
    answer:
      'Moraga\'s pleasant valley climate with warm summers and cool evenings makes concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the Contra Costa County climate.',
  },
  {
    question: 'Do you offer a warranty on Moraga paver installations?',
    answer:
      'Yes. Every paver installation in Moraga comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Moraga?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially with Moraga\'s valley floor and hillside soil conditions.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Moraga"
            afterAlt="Backyard after paver installation in Moraga - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Moraga, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN MORAGA
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Moraga Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Moraga is a quiet, family-oriented Lamorinda town with beautiful open spaces and top schools. Whether you\'re looking for driveway pavers near me or exploring patio paver designs, we create hardscapes that match your home and lifestyle — from Sanders Ranch to Campolindo.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Moraga, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Lafayette, Orinda, Walnut Creek &amp; Canyon &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Moraga — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Moraga Home?
          </h2>
