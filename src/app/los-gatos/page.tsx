...
export const metadata: Metadata = {
  title: 'Paver Installation in Los Gatos, CA | TP Pavers',
  description:
    'Professional paver installation in Los Gatos, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Los Gatos neighborhoods.',
  keywords: [
      "pavers los gatos",
      "los gatos pavers",
      "paver installation los gatos",
      "paver contractor los gatos",
      "driveway pavers los gatos ca",
      "patio pavers los gatos",
      "los gatos paver contractor",
      "pavers in los gatos ca",
      "retaining wall los gatos",
      "hardscape los gatos ca",
      "paver driveway los gatos california",
      "outdoor pavers los gatos"
  ],
  openGraph: {
    title: 'Paver Installation in Los Gatos, CA | TP Pavers',
    description:
      'Expert paver installation in Los Gatos. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/los-gatos',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Los Gatos, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Los Gatos | TP Pavers',
    description: 'Expert paver installation in Los Gatos, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/los-gatos',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Los Gatos',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Los Gatos, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/los-gatos',
...
const services = [
  {
    ...
    description:
      "Upgrade your Los Gatos home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Downtown and Blossom Hill.",
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      "Design the perfect outdoor living space for Los Gatos\'s beautiful weather. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.",
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      "Los Gatos\'s varied terrain often requires structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to properties throughout Shannon and beyond.",
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      "Save water and keep your Los Gatos lawn green year-round. Our premium artificial turf is perfect for families, pets, and California\'s drought-conscious lifestyle.",
  },
];

const faqs = [
  {
    question: "How much do pavers cost in Los Gatos, CA?",
    answer:
      "Paver installation costs in Los Gatos depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Los Gatos homeowners are pleasantly surprised by the value compared to plain concrete.",
  },
  {
    question: "What neighborhoods in Los Gatos do you serve?",
    answer:
      "We serve all of Los Gatos including Downtown, Blossom Hill, Shannon, Roberts, Belgatos. We also cover neighboring cities throughout Santa Clara County.",
  },
  {
    question: "How long does a paver driveway installation take in Los Gatos?",
    answer:
      "Most residential paver projects in Los Gatos — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.",
  },
  {
    question: "What paver materials work best for Los Gatos\'s climate?",
    answer:
      "Los Gatos enjoys a mild Mediterranean climate, making concrete pavers and natural stone excellent choices. Both are durable, weather-resistant, and low-maintenance. We help you select materials that look great and last decades in the Bay Area climate.",
  },
  {
    question: "Do you offer a warranty on Los Gatos paver installations?",
    answer:
      "Yes. Every paver installation in Los Gatos comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in Los Gatos?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for Los Gatos properties.",
  }
];

const neighborhoods = ["Downtown","Blossom Hill","Shannon","Roberts","Belgatos"];

const zipCodes = ["95030","95032"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Los Gatos"
            afterAlt="Backyard after paver installation in Los Gatos - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Los Gatos, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN LOS GATOS
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Los Gatos Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Los Gatos is one of the South Bay\'s most prestigious towns — nestled in the foothills of the Santa Cruz Mountains with a charming downtown, upscale dining, and stunning hillside homes. From the tree-canopied streets near Downtown to the spacious estates of Belgatos, we deliver hardscapes worthy of Los Gatos living.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Los Gatos, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Campbell, Saratoga, San Jose, Monte Sereno & surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Los Gatos — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Los Gatos Home?
          </h2>
