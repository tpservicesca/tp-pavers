...
export const metadata: Metadata = {
  ...
  description:
    'Professional paver installation across 15+ cities in Alameda County. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience, 10-year warranty. Serving Oakland, Berkeley, Fremont, Hayward, Livermore & more. Call (510) 650-2083.',
  keywords: [
