...
export const metadata: Metadata = {
  title: 'Paver Installation in American Canyon, CA | TP Pavers',
  description:
    'Professional paver installation in American Canyon, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving Canyon Estates, Eucalyptus & Napa Junction.',
  keywords: [
    'pavers american canyon',
    'american canyon pavers',
    'paver installation american canyon',
    'paver contractor american canyon',
    'driveway pavers american canyon ca',
    'patio pavers american canyon',
    'american canyon paver contractor',
    'pavers in american canyon ca',
    'retaining wall american canyon',
    'hardscape american canyon ca',
    'paver driveway american canyon california',
    'outdoor pavers american canyon',
    'paver installation near me',
    'driveway pavers near me',
    'backyard pavers american canyon',
  ],
  openGraph: {
    title: 'Paver Installation in American Canyon, CA | TP Pavers',
    description:
      'Expert paver installation in American Canyon. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/american-canyon',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in American Canyon, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in American Canyon | TP Pavers',
    description: 'Expert paver installation in American Canyon, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/american-canyon',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - American Canyon',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in American Canyon, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/american-canyon',
...
const services = [
  {
    ...
    description:
      'Upgrade your American Canyon home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Canyon Estates and Napa Junction.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for American Canyon\'s warm Wine Country climate. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'American Canyon\'s rolling hills and canyon terrain often require structural solutions. Our retaining walls prevent erosion, add usable yard space, and create stunning landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your American Canyon lawn green year-round. Our premium artificial turf is perfect for families, pets, and the warm Napa Valley climate.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in American Canyon, CA?',
    answer:
      'Paver installation costs in American Canyon depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most American Canyon homeowners find pavers offer excellent value.',
  },
  {
    question: 'What neighborhoods in American Canyon do you serve?',
    answer:
      'We serve all of American Canyon including Canyon Estates, Eucalyptus, and Napa Junction. We also cover neighboring cities like Vallejo, Napa, and Fairfield.',
  },
  {
    question: 'How long does a paver driveway installation take in American Canyon?',
    answer:
      'Most residential paver projects in American Canyon — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for American Canyon\'s climate?',
    answer:
      'American Canyon enjoys warm summers and mild winters typical of the Napa Valley gateway, making concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance — perfect for the Wine Country climate.',
  },
  {
    question: 'Do you offer a warranty on American Canyon paver installations?',
    answer:
      'Yes. Every paver installation in American Canyon comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you match pavers to American Canyon\'s newer home styles?',
    answer:
      'Absolutely. American Canyon has many newer developments with modern architectural styles. We offer a wide selection of paver colors, patterns, and materials to complement contemporary, Mediterranean, and craftsman homes throughout the community.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in American Canyon"
            afterAlt="Backyard after paver installation in American Canyon - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving American Canyon, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[4.5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION IN<br />AMERICAN CANYON
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why American Canyon Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            American Canyon is the gateway to Wine Country — a growing community where modern homes meet natural beauty. From the new developments of Canyon Estates to the established neighborhoods near Napa Junction, we design hardscapes that enhance your property&apos;s value and your family&apos;s outdoor lifestyle.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in American Canyon, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            American Canyon Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Vallejo, Napa, Fairfield &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in American Canyon — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your American Canyon Home?
          </h2>
