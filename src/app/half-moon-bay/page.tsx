...
export const metadata: Metadata = {
  title: 'Paver Installation in Half Moon Bay, CA | TP Pavers',
  description:
    'Professional paver installation in Half Moon Bay, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Half Moon Bay neighborhoods.',
  keywords: [
      "pavers half moon bay",
      "half moon bay pavers",
      "paver installation half moon bay",
      "paver contractor half moon bay",
      "driveway pavers half moon bay ca",
      "patio pavers half moon bay",
      "half moon bay paver contractor",
      "pavers in half moon bay ca",
      "retaining wall half moon bay",
      "hardscape half moon bay ca",
      "paver driveway half moon bay california",
      "outdoor pavers half moon bay"
  ],
  openGraph: {
    title: 'Paver Installation in Half Moon Bay, CA | TP Pavers',
    description:
      'Expert paver installation in Half Moon Bay. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/half-moon-bay',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Half Moon Bay, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Half Moon Bay | TP Pavers',
    description: 'Expert paver installation in Half Moon Bay, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/half-moon-bay',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Half Moon Bay',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Half Moon Bay, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/half-moon-bay',
...
const services = [
  {
    ...
    description:
      "Upgrade your Half Moon Bay home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Downtown and Miramar.",
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We serve all of Half Moon Bay including Downtown, Miramar, Princeton, El Granada border, Arleta Park. We also cover neighboring cities throughout San Mateo County.",
  },
  {
    question: "How long does a paver driveway installation take in Half Moon Bay?",
    answer:
  ...
  {
    question: "Do you offer a warranty on Half Moon Bay paver installations?",
    answer:
      "Yes. Every paver installation in Half Moon Bay comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in Half Moon Bay?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for Half Moon Bay properties.",
  }
];

const neighborhoods = ["Downtown","Miramar","Princeton","El Granada border","Arleta Park"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Half Moon Bay"
            afterAlt="Backyard after paver installation in Half Moon Bay - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Half Moon Bay, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN HALF MOON BAY
          </h1>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Half Moon Bay, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Pacifica, Montara, Moss Beach, El Granada & surrounding coastside areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Half Moon Bay — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Half Moon Bay Home?
          </h2>
