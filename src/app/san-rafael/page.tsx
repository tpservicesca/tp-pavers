...
export const metadata: Metadata = {
  title: 'Paver Installation in San Rafael, CA | TP Pavers',
  description:
    'Professional paver installation in San Rafael, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all San Rafael neighborhoods.',
  keywords: [
    'pavers san rafael',
    'san rafael pavers',
    'paver installation san rafael',
    'paver contractor san rafael',
    'driveway pavers san rafael ca',
    'patio pavers san rafael',
    'san rafael paver contractor',
    'pavers in san rafael ca',
    'retaining wall san rafael',
    'hardscape san rafael ca',
    'paver driveway san rafael california',
    'outdoor pavers san rafael',
  ],
  openGraph: {
    title: 'Paver Installation in San Rafael, CA | TP Pavers',
    description:
      'Expert paver installation in San Rafael. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/san-rafael',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in San Rafael, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in San Rafael | TP Pavers',
    description: 'Expert paver installation in San Rafael, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/san-rafael',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - San Rafael',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in San Rafael, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/san-rafael',
...
const services = [
  {
    ...
    description:
      'Upgrade your San Rafael home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Terra Linda, Gerstle Park, and Dominican.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for San Rafael\'s Mediterranean climate. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'San Rafael\'s hilly terrain and hillside neighborhoods often require structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your San Rafael lawn green year-round. Our premium artificial turf is perfect for families, pets, and Marin County\'s eco-conscious lifestyle.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in San Rafael, CA?',
    answer:
      'Paver installation costs in San Rafael depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most San Rafael homeowners are pleasantly surprised by the value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in San Rafael do you serve?',
    answer:
      'We serve all of San Rafael including Terra Linda, Gerstle Park, Dominican, Sun Valley, Peacock Gap, Canal, and Montecito. We also cover neighboring cities like San Anselmo, Larkspur, Novato, and all of Marin County.',
  },
  {
    question: 'How long does a paver driveway installation take in San Rafael?',
    answer:
      'Most residential paver projects in San Rafael — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for San Rafael\'s climate?',
    answer:
      'San Rafael enjoys a Mediterranean climate with mild, wet winters and warm, dry summers. Concrete pavers and natural stone are excellent choices — both handle moisture well and are low-maintenance. We help you select materials that look great and last decades in the Marin County climate.',
  },
  {
    question: 'Do you offer a warranty on San Rafael paver installations?',
    answer:
      'Yes. Every paver installation in San Rafael comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in San Rafael?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially on San Rafael\'s varied terrain.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in San Rafael"
            afterAlt="Backyard after paver installation in San Rafael - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving San Rafael, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN SAN RAFAEL
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why San Rafael Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            San Rafael is the county seat of Marin County — a vibrant city with stunning hillside views, diverse neighborhoods, and homeowners who value quality outdoor living. From the family-friendly streets of Terra Linda to the historic charm of Gerstle Park, we design hardscapes that match your home and lifestyle.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in San Rafael, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: San Anselmo, Larkspur, Novato, Corte Madera &amp; surrounding Marin County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in San Rafael — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your San Rafael Home?
          </h2>
