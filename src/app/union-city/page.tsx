...
export const metadata: Metadata = {
  title: 'Paver Installation in Union City, CA | TP Pavers',
  description:
    'Professional paver installation in Union City, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Union City neighborhoods.',
  keywords: [
    'pavers union city',
    'union city pavers',
    'paver installation union city',
    'paver contractor union city',
    'driveway pavers union city ca',
    'patio pavers union city',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers union city',
    'retaining wall union city',
    'hardscape union city ca',
  ],
  openGraph: {
    title: 'Paver Installation in Union City, CA | TP Pavers',
    description:
      'Expert paver installation in Union City. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/union-city',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Union City, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Union City | TP Pavers',
    description: 'Expert paver installation in Union City, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/union-city',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Union City',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Union City, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/union-city',
...
const services = [
  {
    ...
    description:
      'Upgrade your Union City home with a custom interlocking paver driveway. From the historic Alvarado district to the modern Station District near BART, our driveways are built for beauty and durability.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Union City\'s warm climate. Whether you\'re in Decoto or near Union Landing, we create beautiful patios and walkways that extend your living space and boost property value.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Union City\'s hillside properties and sloped lots benefit from expertly constructed retaining walls. We build structural walls that maximize usable yard space, prevent erosion, and add elegant landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Union City lawn green year-round. Our premium artificial turf is perfect for families and pets in every neighborhood, from Searles to Holly Community — a smart, eco-friendly choice.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Union City, CA?',
    answer:
      'Paver installation costs in Union City depend on the project size, materials chosen, and site preparation needed. We provide free on-site estimates with transparent pricing for driveways, patios, and walkways. Most Union City homeowners find pavers offer excellent long-term value.',
  },
  {
    question: 'What neighborhoods in Union City do you serve?',
    answer:
      'We serve all of Union City including Alvarado, Decoto, Station District, Searles, Union Landing, and Holly Community. We also cover neighboring cities like Fremont, Hayward, Newark, and Castro Valley.',
  },
  {
    question: 'How long does a paver driveway installation take in Union City?',
    answer:
      'Most residential paver projects in Union City — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing with a detailed timeline provided upfront.',
  },
  {
    question: 'What paver materials work best for Union City\'s climate?',
    answer:
      'Union City enjoys warm summers and mild winters, making concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance — perfect for the East Bay climate. We help you select the ideal materials for your project.',
  },
  {
    question: 'Do you offer a warranty on Union City paver installations?',
    answer:
      'Yes. Every paver installation in Union City comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you install pavers near the Union City BART station area?',
    answer:
      'Absolutely. We serve all areas of Union City including the growing Station District near BART. Whether it\'s a new construction project or a renovation, we deliver premium paver installations that enhance any property in Union City.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Union City"
            afterAlt="Backyard after paver installation in Union City - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Union City, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN UNION CITY
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Union City Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Union City is a growing community with a rich history and diverse neighborhoods. From the historic Alvarado district to the transit-oriented Station District, we design hardscapes that enhance your property and create beautiful outdoor living spaces for every style of home.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Union City, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Fremont, Hayward, Newark, Castro Valley &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Union City — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Union City Home?
          </h2>
