...
export const metadata: Metadata = {
  title: 'Paver Installation in Cupertino, CA | TP Pavers',
  description:
    'Professional paver installation in Cupertino, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Cupertino neighborhoods.',
  keywords: [
      "pavers cupertino",
      "cupertino pavers",
      "paver installation cupertino",
      "paver contractor cupertino",
      "driveway pavers cupertino ca",
      "patio pavers cupertino",
      "cupertino paver contractor",
      "pavers in cupertino ca",
      "retaining wall cupertino",
      "hardscape cupertino ca",
      "paver driveway cupertino california",
      "outdoor pavers cupertino"
  ],
  openGraph: {
    title: 'Paver Installation in Cupertino, CA | TP Pavers',
    description:
      'Expert paver installation in Cupertino. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/cupertino',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Cupertino, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Cupertino | TP Pavers',
    description: 'Expert paver installation in Cupertino, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/cupertino',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Cupertino',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Cupertino, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/cupertino',
...
const services = [
  {
    ...
    description:
      "Upgrade your Cupertino home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Rancho Rinconada and Monta Vista.",
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We serve all of Cupertino including Rancho Rinconada, Monta Vista, Garden Gate, Homestead. We also cover neighboring cities throughout Santa Clara County.",
  },
  {
    question: "How long does a paver driveway installation take in Cupertino?",
    answer:
  ...
  {
    question: "Do you offer a warranty on Cupertino paver installations?",
    answer:
      "Yes. Every paver installation in Cupertino comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in Cupertino?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for Cupertino properties.",
  }
];

const neighborhoods = ["Rancho Rinconada","Monta Vista","Garden Gate","Homestead"];

const zipCodes = ["95014"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Cupertino"
            afterAlt="Backyard after paver installation in Cupertino - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Cupertino, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN CUPERTINO
          </h1>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Cupertino, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Sunnyvale, Santa Clara, San Jose, Saratoga & surrounding South Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Cupertino — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Cupertino Home?
          </h2>
