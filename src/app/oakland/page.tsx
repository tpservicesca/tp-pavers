...
export const metadata: Metadata = {
  title: 'Paver Installation in Oakland, CA | TP Pavers',
  description:
    'Professional paver installation in Oakland, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Oakland neighborhoods.',
  keywords: [
    'pavers oakland',
    'oakland pavers',
    'paver installation oakland',
    'paver contractor oakland',
    'driveway pavers oakland ca',
    'patio pavers oakland',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers oakland',
    'retaining wall oakland',
    'hardscape oakland ca',
  ],
  openGraph: {
    title: 'Paver Installation in Oakland, CA | TP Pavers',
    description:
      'Expert paver installation in Oakland. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/oakland',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Oakland, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Oakland | TP Pavers',
    description: 'Expert paver installation in Oakland, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/oakland',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Oakland',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Oakland, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/oakland',
...
const services = [
  {
    ...
    description:
      'Upgrade your Oakland home with a custom interlocking paver driveway. From the tree-lined streets of Rockridge to the elegant avenues of Montclair, our driveways are built to handle daily traffic and elevate your curb appeal.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Oakland\'s Mediterranean climate. Whether you\'re near Lake Merritt or in the Grand Lake district, we create beautiful backyard patios and front walkways that last decades.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Oakland\'s hilly terrain in neighborhoods like Montclair and the Oakland Hills demands expert structural solutions. Our retaining walls prevent erosion, create usable tiered landscapes, and add lasting value.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Oakland lawn green year-round. Our premium artificial turf is perfect for families and pets in neighborhoods from Temescal to Piedmont Avenue, ideal for California\'s drought-conscious lifestyle.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Oakland, CA?',
    answer:
      'Paver installation costs in Oakland depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway in Rockridge or a patio in Glenview, we provide free on-site estimates with transparent pricing. Most Oakland homeowners find pavers offer excellent long-term value compared to poured concrete.',
  },
  {
    question: 'What neighborhoods in Oakland do you serve?',
    answer:
      'We serve all of Oakland including Rockridge, Montclair, Temescal, Lake Merritt, Piedmont Avenue, Grand Lake, Glenview, Dimond, Fruitvale, and Jack London Square. We also cover neighboring cities like Berkeley, Alameda, San Leandro, and Emeryville.',
  },
  {
    question: 'How long does a paver driveway installation take in Oakland?',
    answer:
      'Most residential paver projects in Oakland — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Oakland\'s climate?',
    answer:
      'Oakland enjoys a mild Mediterranean climate with warm, dry summers and cool, wet winters. Concrete pavers and natural stone are excellent choices — both are durable, slip-resistant when sealed, and low-maintenance. We help you select materials that perform beautifully in the East Bay climate.',
  },
  {
    question: 'Do you offer a warranty on Oakland paver installations?',
    answer:
      'Yes. Every paver installation in Oakland comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for every project.',
  },
  {
    question: 'Can you build retaining walls on Oakland\'s hillside properties?',
    answer:
      'Absolutely. Oakland\'s hilly terrain — especially in Montclair, the Oakland Hills, and upper Rockridge — often requires retaining walls. We design and build structural walls that prevent erosion, add usable yard space, and complement your landscape beautifully.',
  },
];
...
const zipCodes = ['94601', '94602', '94603', '94605', '94606', '94607', '94608', '94609', '94610', '94611', '94612', '94613', '94618', '94619', '94621'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Oakland"
            afterAlt="Backyard after paver installation in Oakland - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Oakland, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN OAKLAND
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Oakland Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Oakland is a vibrant city with diverse neighborhoods, stunning hills, and homeowners who appreciate quality craftsmanship. From the charming bungalows of Rockridge to the hillside estates of Montclair, we design hardscapes that complement your home and enhance your outdoor living.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Oakland, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Berkeley, Alameda, San Leandro, Emeryville &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Oakland — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Oakland Home?
          </h2>
