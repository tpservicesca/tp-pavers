...
export const metadata: Metadata = {
  title: 'Paver Installation in Vallejo, CA | TP Pavers',
  description:
    'Professional paver installation in Vallejo, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Vallejo neighborhoods including Glen Cove, Hiddenbrooke & South Vallejo.',
  keywords: [
    'pavers vallejo',
    'vallejo pavers',
    'paver installation vallejo',
    'paver contractor vallejo',
    'driveway pavers vallejo ca',
    'patio pavers vallejo',
    'vallejo paver contractor',
    'pavers in vallejo ca',
    'retaining wall vallejo',
    'hardscape vallejo ca',
    'paver driveway vallejo california',
    'outdoor pavers vallejo',
    'paver installation near me',
    'driveway pavers near me',
    'backyard pavers vallejo',
  ],
  openGraph: {
    title: 'Paver Installation in Vallejo, CA | TP Pavers',
    description:
      'Expert paver installation in Vallejo. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/vallejo',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Vallejo, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Vallejo | TP Pavers',
    description: 'Expert paver installation in Vallejo, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/vallejo',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Vallejo',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Vallejo, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/vallejo',
...
const services = [
  {
    ...
    description:
      'Upgrade your Vallejo home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Glen Cove and Hiddenbrooke.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Vallejo\'s mild waterfront climate. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Vallejo\'s hilly terrain from South Vallejo to Country Club Crest often requires structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Vallejo lawn green year-round. Our premium artificial turf is perfect for families, pets, and Solano County\'s warm climate.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Vallejo, CA?',
    answer:
      'Paver installation costs in Vallejo depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Vallejo homeowners are pleasantly surprised by the value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Vallejo do you serve?',
    answer:
      'We serve all of Vallejo including Glen Cove, South Vallejo, Hiddenbrooke, Country Club Crest, Vallejo Heights, and the Springs area. We also cover neighboring cities like Benicia, American Canyon, and Hercules.',
  },
  {
    question: 'How long does a paver driveway installation take in Vallejo?',
    answer:
      'Most residential paver projects in Vallejo — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Vallejo\'s climate?',
    answer:
      'Vallejo enjoys a mild maritime climate with cool breezes off the Carquinez Strait, making concrete pavers and natural stone excellent choices. Both are durable, low-maintenance, and look great for decades in the North Bay climate.',
  },
  {
    question: 'Do you offer a warranty on Vallejo paver installations?',
    answer:
      'Yes. Every paver installation in Vallejo comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Vallejo?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially on Vallejo\'s varied soil conditions near the waterfront.',
  },
];
...
const zipCodes = ['94589', '94590', '94591'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Vallejo"
            afterAlt="Backyard after paver installation in Vallejo - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Vallejo, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN VALLEJO
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Vallejo Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Vallejo is a vibrant waterfront city with stunning views of the Carquinez Strait and San Pablo Bay. From the upscale homes of Hiddenbrooke to the charming neighborhoods of Glen Cove, we design hardscapes that complement your home and withstand Vallejo&apos;s unique coastal climate.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Vallejo, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Vallejo Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Benicia, American Canyon, Hercules &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Vallejo — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Vallejo Home?
          </h2>
