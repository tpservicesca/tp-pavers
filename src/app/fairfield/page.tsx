...
export const metadata: Metadata = {
  title: 'Paver Installation in Fairfield, CA | TP Pavers',
  description:
    'Professional paver installation in Fairfield, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving Green Valley, Cordelia, Rancho Solano & all Fairfield neighborhoods.',
  keywords: [
    'pavers fairfield',
    'fairfield pavers',
    'paver installation fairfield',
    'paver contractor fairfield',
    'driveway pavers fairfield ca',
    'patio pavers fairfield',
    'fairfield paver contractor',
    'pavers in fairfield ca',
    'retaining wall fairfield',
    'hardscape fairfield ca',
    'paver driveway fairfield california',
    'outdoor pavers fairfield',
    'paver installation near me',
    'driveway pavers near me',
    'backyard pavers fairfield',
  ],
  openGraph: {
    title: 'Paver Installation in Fairfield, CA | TP Pavers',
    description:
      'Expert paver installation in Fairfield. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/fairfield',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Fairfield, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Fairfield | TP Pavers',
    description: 'Expert paver installation in Fairfield, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/fairfield',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Fairfield',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Fairfield, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/fairfield',
...
const services = [
  {
    ...
    description:
      'Upgrade your Fairfield home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Rancho Solano and Cordelia.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Fairfield\'s warm summers. From backyard patios in Green Valley to front walkways in Tolenas, we create durable and beautiful hardscapes.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Fairfield\'s rolling terrain in areas like Suisun Valley and Green Valley often requires structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Fairfield lawn green year-round. Our premium artificial turf is perfect for families, pets, and Solano County\'s hot summer climate.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Fairfield, CA?',
    answer:
      'Paver installation costs in Fairfield depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Fairfield homeowners are pleasantly surprised by the value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Fairfield do you serve?',
    answer:
      'We serve all of Fairfield including Green Valley, Suisun Valley, Cordelia, Rancho Solano, and Tolenas. We also cover neighboring cities like Vacaville, Suisun City, and Vallejo.',
  },
  {
    question: 'How long does a paver driveway installation take in Fairfield?',
    answer:
      'Most residential paver projects in Fairfield — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Fairfield\'s climate?',
    answer:
      'Fairfield experiences hot, dry summers and mild winters with Delta breezes. Concrete pavers and natural stone are excellent choices — both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in Solano County\'s climate.',
  },
  {
    question: 'Do you offer a warranty on Fairfield paver installations?',
    answer:
      'Yes. Every paver installation in Fairfield comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Fairfield?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we ensure proper drainage — especially important in Fairfield\'s clay-rich soil areas.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Fairfield"
            afterAlt="Backyard after paver installation in Fairfield - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Fairfield, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN FAIRFIELD
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Fairfield Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Fairfield is the heart of Solano County — a thriving city with diverse neighborhoods, excellent schools, and easy access to both the Bay Area and Sacramento. From the upscale homes of Rancho Solano to the scenic beauty of Green Valley, we design hardscapes that match your home and lifestyle.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Fairfield, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Vacaville, Suisun City, Vallejo &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Fairfield — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Fairfield Home?
          </h2>
