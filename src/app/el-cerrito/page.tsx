...
export const metadata: Metadata = {
  title: 'Paver Installation in El Cerrito, CA | TP Pavers',
  description:
    'Professional paver installation in El Cerrito, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all El Cerrito neighborhoods.',
  keywords: [
    'pavers el cerrito',
    'el cerrito pavers',
    'paver installation el cerrito',
    'paver contractor el cerrito',
    'driveway pavers el cerrito ca',
    'patio pavers el cerrito',
    'el cerrito paver contractor',
    'pavers in el cerrito ca',
    'retaining wall el cerrito',
    'hardscape el cerrito ca',
    'paver driveway el cerrito california',
    'outdoor pavers el cerrito',
  ],
  openGraph: {
    title: 'Paver Installation in El Cerrito, CA | TP Pavers',
    description:
      'Expert paver installation in El Cerrito. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/el-cerrito',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in El Cerrito, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in El Cerrito | TP Pavers',
    description: 'Expert paver installation in El Cerrito, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/el-cerrito',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - El Cerrito',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in El Cerrito, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/el-cerrito',
...
const services = [
  {
    ...
    description:
      'Upgrade your El Cerrito home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like El Cerrito Hills and Sunset View.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for El Cerrito\'s hillside homes with panoramic bay views and BART-accessible neighborhoods. From backyard pavers to front walkways, we create durable patio paver designs for every El Cerrito home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'El Cerrito\'s terrain near the steep hillside terrain with bay views throughout El Cerrito often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your El Cerrito lawn green year-round. Our premium artificial turf is perfect for families, pets, and El Cerrito\'s mild coastal climate moderated by San Francisco Bay breezes.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in El Cerrito, CA?',
    answer:
      'Paver installation cost in El Cerrito depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most El Cerrito homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in El Cerrito do you serve?',
    answer:
      'We serve all of El Cerrito including El Cerrito Hills, Kensington border, Sunset View, Madera. We also cover neighboring cities like Richmond, Albany, Kensington, Berkeley and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in El Cerrito?',
    answer:
      'Most residential paver projects in El Cerrito — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for El Cerrito\'s climate?',
    answer:
      'El Cerrito\'s mild coastal climate moderated by San Francisco Bay breezes makes concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the Contra Costa County climate.',
  },
  {
    question: 'Do you offer a warranty on El Cerrito paver installations?',
    answer:
      'Yes. Every paver installation in El Cerrito comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in El Cerrito?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially with El Cerrito\'s hillside clay soil.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in El Cerrito"
            afterAlt="Backyard after paver installation in El Cerrito - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving El Cerrito, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN EL CERRITO
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why El Cerrito Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            El Cerrito is a vibrant hillside city with stunning bay views and diverse, walkable neighborhoods. Whether you\'re looking for driveway pavers near me or exploring patio paver designs, we create hardscapes that match your home and lifestyle — from El Cerrito Hills to Sunset View.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in El Cerrito, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Richmond, Albany, Kensington &amp; Berkeley &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in El Cerrito — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your El Cerrito Home?
          </h2>
