...
export const metadata: Metadata = {
  title: 'Paver Installation in Kensington, CA | TP Pavers',
  description:
    'Professional paver installation in Kensington, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Kensington neighborhoods.',
  keywords: [
    'pavers kensington',
    'kensington pavers',
    'paver installation kensington',
    'paver contractor kensington',
    'driveway pavers kensington ca',
    'patio pavers kensington',
    'kensington paver contractor',
    'pavers in kensington ca',
    'retaining wall kensington',
    'hardscape kensington ca',
    'paver driveway kensington california',
    'outdoor pavers kensington',
  ],
  openGraph: {
    title: 'Paver Installation in Kensington, CA | TP Pavers',
    description:
      'Expert paver installation in Kensington. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/kensington',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Kensington, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Kensington | TP Pavers',
    description: 'Expert paver installation in Kensington, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/kensington',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Kensington',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Kensington, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/kensington',
...
const services = [
  {
    ...
    description:
      'Upgrade your Kensington home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Kensington Park and Arlington.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Kensington\'s exclusive hillside homes with sweeping Golden Gate and bay views. From backyard pavers to front walkways, we create durable patio paver designs for every Kensington home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Kensington\'s terrain near the steep hillside terrain with panoramic bay views often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Kensington lawn green year-round. Our premium artificial turf is perfect for families, pets, and Kensington\'s mild, fog-moderated climate with comfortable year-round temperatures.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in Kensington, CA?',
    answer:
      'Paver installation cost in Kensington depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Kensington homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Kensington do you serve?',
    answer:
      'We serve all of Kensington including Kensington Park, Arlington, Sunset View. We also cover neighboring cities like El Cerrito, Berkeley, Albany, Richmond and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Kensington?',
    answer:
      'Most residential paver projects in Kensington — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Kensington\'s climate?',
    answer:
      'Kensington\'s mild, fog-moderated climate with comfortable year-round temperatures makes concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the Contra Costa County climate.',
  },
  {
    question: 'Do you offer a warranty on Kensington paver installations?',
    answer:
      'Yes. Every paver installation in Kensington comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Kensington?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially with Kensington\'s steep hillside clay soil.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Kensington"
            afterAlt="Backyard after paver installation in Kensington - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Kensington, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN KENSINGTON
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Kensington Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Kensington is an upscale hillside community with panoramic bay views and a village atmosphere. Whether you\'re looking for driveway pavers near me or exploring patio paver designs, we create hardscapes that match your home and lifestyle — from Kensington Park to Arlington.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Kensington, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Kensington Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: El Cerrito, Berkeley, Albany &amp; Richmond &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Kensington — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Kensington Home?
          </h2>
