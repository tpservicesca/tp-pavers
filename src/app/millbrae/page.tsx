...
export const metadata: Metadata = {
  title: 'Paver Installation in Millbrae, CA | TP Pavers',
  description:
    'Professional paver installation in Millbrae, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Millbrae neighborhoods.',
  keywords: [
    'pavers millbrae',
    'millbrae pavers',
    'paver installation millbrae',
    'paver contractor millbrae',
    'driveway pavers millbrae ca',
    'patio pavers millbrae',
    'millbrae paver contractor',
    'pavers in millbrae ca',
    'retaining wall millbrae',
    'hardscape millbrae ca',
    'paver driveway millbrae california',
    'outdoor pavers millbrae',
  ],
  openGraph: {
    title: 'Paver Installation in Millbrae, CA | TP Pavers',
    description:
      'Expert paver installation in Millbrae. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/millbrae',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Millbrae, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Millbrae | TP Pavers',
    description: 'Expert paver installation in Millbrae, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/millbrae',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Millbrae',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Millbrae, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/millbrae',
...
const services = [
  {
    ...
    description:
      'Upgrade your Millbrae home with a stunning interlocking paver driveway. Whether you live in the prestigious Mills Estates or the welcoming Meadows neighborhood, our driveways are built for beauty and durability.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Enjoy Millbrae&apos;s pleasant Bay Area climate with a custom patio or walkway. Perfect for weekend barbecues and family gatherings, our outdoor spaces are designed to enhance your home&apos;s livability.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Millbrae&apos;s hillside neighborhoods like Millbrae Highlands and Green Hills often benefit from retaining walls. We engineer walls that solve drainage issues while adding stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Keep your Millbrae lawn green and maintenance-free all year long. Our premium synthetic turf saves water and looks great, ideal for families and pets in this transit-friendly Peninsula city.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Millbrae, CA?',
    answer:
      'Paver costs in Millbrae vary by project scope, material selection, and site conditions. We offer free on-site estimates with clear, upfront pricing. Most Millbrae homeowners find pavers provide outstanding value compared to stamped or plain concrete.',
  },
  {
    question: 'What neighborhoods in Millbrae do you serve?',
    answer:
      'We serve all of Millbrae including Meadows, Mills Estates, Millbrae Highlands, Green Hills, and Central Millbrae. We also cover nearby Burlingame, San Bruno, South San Francisco, and San Mateo.',
  },
  {
    question: 'How long does a paver project take in Millbrae?',
    answer:
      'Most residential paver projects in Millbrae are completed within 1 to 2 weeks. We manage everything from demolition to sealing and provide a clear timeline during your free consultation.',
  },
  {
    question: 'What paver materials work best for Millbrae&apos;s climate?',
    answer:
      'Millbrae&apos;s mild coastal climate makes it ideal for concrete pavers, natural stone, and porcelain options. All are durable, weather-resistant, and low-maintenance. We help you choose materials that suit both your style and the local conditions.',
  },
  {
    question: 'Do you offer a warranty on Millbrae paver installations?',
    answer:
      'Yes. Every paver installation in Millbrae comes with our 10-year warranty covering both labor and materials. We use only premium-grade products and stand behind every project.',
  },
  {
    question: 'Can you handle sloped driveways in Millbrae&apos;s hillside areas?',
    answer:
      'Absolutely. Many Millbrae properties in areas like Millbrae Highlands and Green Hills have sloped driveways. We have extensive experience with grading, drainage solutions, and proper base preparation for hillside installations.',
  },
];

const neighborhoods = ['Meadows', 'Mills Estates', 'Millbrae Highlands', 'Green Hills', 'Central Millbrae'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Millbrae"
            afterAlt="Backyard after paver installation in Millbrae - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Millbrae, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN MILLBRAE
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Millbrae Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Millbrae — a charming Peninsula city perfectly positioned between San Francisco and Silicon Valley — offers hillside views, excellent transit connections, and a strong sense of community. From the elegant Mills Estates to the family-friendly Meadows, we craft hardscapes that enhance Millbrae&apos;s welcoming residential character.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Millbrae, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Burlingame, San Bruno, South San Francisco, San Mateo &amp; surrounding Peninsula areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Millbrae — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Millbrae Home?
          </h2>
