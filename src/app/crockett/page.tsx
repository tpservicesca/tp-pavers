...
export const metadata: Metadata = {
  title: 'Paver Installation in Crockett, CA | TP Pavers',
  description:
    'Professional paver installation in Crockett, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Crockett neighborhoods.',
  keywords: [
    'pavers crockett',
    'crockett pavers',
    'paver installation crockett',
    'paver contractor crockett',
    'driveway pavers crockett ca',
    'patio pavers crockett',
    'crockett paver contractor',
    'pavers in crockett ca',
    'retaining wall crockett',
    'hardscape crockett ca',
    'paver driveway crockett california',
    'outdoor pavers crockett',
  ],
  openGraph: {
    title: 'Paver Installation in Crockett, CA | TP Pavers',
    description:
      'Expert paver installation in Crockett. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/crockett',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Crockett, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Crockett | TP Pavers',
    description: 'Expert paver installation in Crockett, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/crockett',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Crockett',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Crockett, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/crockett',
...
const services = [
  {
    ...
    description:
      'Upgrade your Crockett home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Crockett Hills and the Port Costa border area.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Crockett\'s terrain near the steep hillsides overlooking the Carquinez Strait often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
...
const faqs = [
  {
    question: 'How much does paver installation cost in Crockett, CA?',
    answer:
      'Paver installation cost in Crockett depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Crockett homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Crockett do you serve?',
    answer:
      'We serve all of Crockett including Crockett Hills, Port Costa border. We also cover neighboring cities like Rodeo, Hercules, Martinez, Port Costa and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Crockett?',
    answer:
      'Most residential paver projects in Crockett — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Every paver installation in Crockett comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Crockett"
            afterAlt="Backyard after paver installation in Crockett - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Crockett, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN CROCKETT
          </h1>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Crockett, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Crockett Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Rodeo, Hercules, Martinez &amp; Port Costa &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Crockett — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Crockett Home?
          </h2>
