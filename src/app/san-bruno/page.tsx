...
export const metadata: Metadata = {
  title: 'Paver Installation in San Bruno, CA | TP Pavers',
  description:
    'Professional paver installation in San Bruno, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all San Bruno neighborhoods.',
  keywords: [
      "pavers san bruno",
      "san bruno pavers",
      "paver installation san bruno",
      "paver contractor san bruno",
      "driveway pavers san bruno ca",
      "patio pavers san bruno",
      "san bruno paver contractor",
      "pavers in san bruno ca",
      "retaining wall san bruno",
      "hardscape san bruno ca",
      "paver driveway san bruno california",
      "outdoor pavers san bruno"
  ],
  openGraph: {
    title: 'Paver Installation in San Bruno, CA | TP Pavers',
    description:
      'Expert paver installation in San Bruno. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/san-bruno',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in San Bruno, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in San Bruno | TP Pavers',
    description: 'Expert paver installation in San Bruno, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/san-bruno',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - San Bruno',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in San Bruno, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/san-bruno',
...
const services = [
  {
    ...
    description:
      "Upgrade your San Bruno home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Crestmoor and Mills Park.",
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We serve all of San Bruno including Crestmoor, Mills Park, Rollingwood, Bayhill, Downtown. We also cover neighboring cities throughout San Mateo County.",
  },
  {
    question: "How long does a paver driveway installation take in San Bruno?",
    answer:
  ...
  {
    question: "Do you offer a warranty on San Bruno paver installations?",
    answer:
      "Yes. Every paver installation in San Bruno comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in San Bruno?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for San Bruno properties.",
  }
];

const neighborhoods = ["Crestmoor","Mills Park","Rollingwood","Bayhill","Downtown"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in San Bruno"
            afterAlt="Backyard after paver installation in San Bruno - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving San Bruno, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN SAN BRUNO
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why San Bruno Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            San Bruno is a centrally located Peninsula city with friendly neighborhoods, easy freeway access, and a welcoming community. From the elevated homes of Crestmoor to the tree-lined streets near Mills Park, we craft hardscapes that make the most of your outdoor space.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in San Bruno, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: South San Francisco, Millbrae, Burlingame, San Mateo & surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in San Bruno — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your San Bruno Home?
          </h2>
