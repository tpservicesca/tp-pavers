...
export const metadata: Metadata = {
  title: 'Paver Installation in Fremont, CA | TP Pavers',
  description:
    'Professional paver installation in Fremont, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Fremont neighborhoods.',
  keywords: [
    'pavers fremont',
    'fremont pavers',
    'paver installation fremont',
    'paver contractor fremont',
    'driveway pavers fremont ca',
    'patio pavers fremont',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers fremont',
    'retaining wall fremont',
    'hardscape fremont ca',
  ],
  openGraph: {
    title: 'Paver Installation in Fremont, CA | TP Pavers',
    description:
      'Expert paver installation in Fremont. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/fremont',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Fremont, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Fremont | TP Pavers',
    description: 'Expert paver installation in Fremont, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/fremont',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Fremont',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Fremont, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/fremont',
...
const services = [
  {
    ...
    description:
      'Upgrade your Fremont home with a custom interlocking paver driveway. From the historic charm of Niles to the modern developments of Warm Springs, our driveways are built for lasting beauty and daily performance.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Fremont\'s warm, sunny climate. Whether you\'re in Mission San Jose or Irvington, we create beautiful backyard patios and walkways ideal for entertaining and relaxation.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Fremont\'s terrain near the Mission Hills and east side foothills often requires structural retaining walls. We build walls that prevent erosion, add usable space, and enhance your landscape design.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Fremont lawn green year-round. Our premium artificial turf is perfect for families and pets in neighborhoods from Centerville to Glenmoor, ideal for California\'s water-conscious lifestyle.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Fremont, CA?',
    answer:
      'Paver installation costs in Fremont depend on the project size, materials chosen, and site preparation. Whether it\'s a driveway in Warm Springs or a patio in Mission San Jose, we provide free on-site estimates with transparent pricing. Most Fremont homeowners find pavers an excellent investment in their property.',
  },
  {
    question: 'What neighborhoods in Fremont do you serve?',
    answer:
      'We serve all of Fremont including Niles, Mission San Jose, Warm Springs, Irvington, Centerville, Sundale, Glenmoor, and Parkmont. We also cover neighboring cities like Newark, Union City, Milpitas, and Hayward.',
  },
  {
    question: 'How long does a paver driveway installation take in Fremont?',
    answer:
      'Most residential paver projects in Fremont — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Fremont\'s climate?',
    answer:
      'Fremont enjoys a warm Mediterranean climate with hot, dry summers. Concrete pavers and natural stone are excellent choices — both are heat-resistant, durable, and require minimal maintenance. We help you select materials that look great and perform beautifully year after year.',
  },
  {
    question: 'Do you offer a warranty on Fremont paver installations?',
    answer:
      'Yes. Every paver installation in Fremont comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Fremont?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — delivering exceptional results for Fremont homeowners.',
  },
];
...
const zipCodes = ['94536', '94538', '94539', '94555'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Fremont"
            afterAlt="Backyard after paver installation in Fremont - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Fremont, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN FREMONT
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Fremont Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Fremont is one of Alameda County\'s largest and most diverse cities, blending historic districts like Niles with modern communities like Warm Springs. From spacious suburban homes to hillside properties near Mission Peak, we design hardscapes that match your lifestyle and neighborhood character.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Fremont, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Newark, Union City, Milpitas, Hayward &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Fremont — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Fremont Home?
          </h2>
