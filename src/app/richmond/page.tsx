...
export const metadata: Metadata = {
  title: 'Paver Installation in Richmond, CA | TP Pavers',
  description:
    'Professional paver installation in Richmond, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Richmond neighborhoods.',
  keywords: [
    'pavers richmond',
    'richmond pavers',
    'paver installation richmond',
    'paver contractor richmond',
    'driveway pavers richmond ca',
    'patio pavers richmond',
    'richmond paver contractor',
    'pavers in richmond ca',
    'retaining wall richmond',
    'hardscape richmond ca',
    'paver driveway richmond california',
    'outdoor pavers richmond',
  ],
  openGraph: {
    title: 'Paver Installation in Richmond, CA | TP Pavers',
    description:
      'Expert paver installation in Richmond. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/richmond',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Richmond, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Richmond | TP Pavers',
    description: 'Expert paver installation in Richmond, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/richmond',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Richmond',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Richmond, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/richmond',
...
const services = [
  {
    ...
    description:
      'Upgrade your Richmond home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Point Richmond and Marina Bay.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Richmond\'s diverse neighborhoods from the charming Point Richmond to the scenic Marina Bay. From backyard pavers to front walkways, we create durable patio paver designs for every Richmond home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Richmond\'s terrain near the varied terrain from waterfront areas to the Hilltop hills often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Richmond lawn green year-round. Our premium artificial turf is perfect for families, pets, and Richmond\'s mild bay-influenced climate with cooling coastal breezes.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in Richmond, CA?',
    answer:
      'Paver installation cost in Richmond depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Richmond homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Richmond do you serve?',
    answer:
      'We serve all of Richmond including Point Richmond, Marina Bay, Hilltop, El Sobrante border, Iron Triangle. We also cover neighboring cities like San Pablo, El Cerrito, Pinole, Berkeley and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Richmond?',
    answer:
      'Most residential paver projects in Richmond — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Richmond\'s climate?',
    answer:
      'Richmond\'s mild bay-influenced climate with cooling coastal breezes makes concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the Contra Costa County climate.',
  },
  {
    question: 'Do you offer a warranty on Richmond paver installations?',
    answer:
      'Yes. Every paver installation in Richmond comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Richmond?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially with Richmond\'s varied soil conditions across its diverse terrain.',
  },
];
...
const zipCodes = ['94801', '94804', '94805', '94806'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Richmond"
            afterAlt="Backyard after paver installation in Richmond - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Richmond, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN RICHMOND
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Richmond Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Richmond is a diverse, revitalizing waterfront city with historic charm and growing neighborhoods. Whether you\'re looking for driveway pavers near me or exploring patio paver designs, we create hardscapes that match your home and lifestyle — from Point Richmond to Marina Bay.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Richmond, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: San Pablo, El Cerrito, Pinole &amp; Berkeley &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Richmond — Common Questions
          </h2>
