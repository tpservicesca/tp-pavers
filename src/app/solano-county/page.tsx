...
export const metadata: Metadata = {
  ...
  description:
    'Professional paver installation across 7 cities in Solano County, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience, 10-year warranty. Serving Vallejo, Fairfield, Vacaville, Benicia & more. Call (510) 650-2083.',
  keywords: [
