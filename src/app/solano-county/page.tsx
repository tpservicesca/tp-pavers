...
export const metadata: Metadata = {
  title: 'Paver Installation in Solano County, CA | TP Pavers',
  description:
    'Professional paver installation across 7 cities in Solano County, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience, 10-year warranty. Serving Vallejo, Fairfield, Vacaville, Benicia & more. Call (510) 650-0080.',
  keywords: [
    'pavers solano county',
    'paver contractor solano county',
    'paver installation solano county',
    'driveway pavers solano county',
    'patio pavers solano county',
    'hardscape contractor solano county',
    'retaining wall solano county',
    'synthetic turf solano county',
    'concrete pavers solano county',
    'walkway pavers solano county ca',
    'outdoor pavers solano county ca',
    'paver company solano county',
    'best paver contractor solano county',
    'interlocking pavers solano county',
  ...
  openGraph: {
    title: 'Paver Installation in Solano County, CA | TP Pavers',
    description:
      'Serving 7 cities across Solano County. Premium paver installation for driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Solano County, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Solano County | TP Pavers',
    description:
      'Expert paver installation across Solano County. 7 cities served. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/solano-county',
  },
  robots: {
    index: true,
    follow: true,
...
const CITIES_WITH_PAGES = [
  { name: 'Vallejo', slug: 'vallejo', tagline: 'Waterfront City' },
  { name: 'Benicia', slug: 'benicia', tagline: 'Historic Charm' },
  { name: 'American Canyon', slug: 'american-canyon', tagline: 'Wine Country Gateway' },
  { name: 'Fairfield', slug: 'fairfield', tagline: 'County Seat' },
  { name: 'Vacaville', slug: 'vacaville', tagline: 'Growing Community' },
  { name: 'Suisun City', slug: 'suisun-city', tagline: 'Waterfront Living' },
  { name: 'Dixon', slug: 'dixon', tagline: 'Small Town Heart' },
];
...
const services = [
  {
    ...
    description:
      'Upgrade your Solano County home with a custom interlocking paver driveway. Durable, beautiful, and built to handle daily traffic across every neighborhood from Vallejo to Vacaville.',
  },
  {
    image: '/images/projects/patio-curved-seatwall.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Solano County\'s warm Mediterranean climate. From backyard patios to front walkways, we create hardscapes that last for decades.',
  },
  {
    image: '/images/R2.webp',
    title: 'Retaining Walls',
    description:
      'Solano County\'s varied terrain — from Vallejo\'s hillsides to Fairfield\'s rolling landscapes — often requires structural solutions. Our retaining walls prevent erosion and add stunning tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your lawn green year-round. Our premium artificial turf is perfect for Solano County families, pets, and California\'s drought-conscious lifestyle.',
  },
];
...
const faqs = [
  {
    question: 'How much do pavers cost in Solano County?',
    answer:
      'Paver installation costs in Solano County depend on project size, materials chosen, and site preparation needed. We provide free on-site estimates with transparent pricing for driveways, patios, walkways, and retaining walls. Most homeowners find pavers offer excellent long-term value compared to poured concrete.',
  },
  {
    question: 'What cities in Solano County do you serve?',
    answer:
      'We serve all cities across Solano County, including Vallejo, Benicia, American Canyon, Fairfield, Vacaville, Suisun City, and Dixon. Whether you\'re near the waterfront in Vallejo or the farmlands of Dixon, we bring expert paver installation to your doorstep.',
  },
  {
    question: 'What paver materials work best for Solano County\'s climate?',
    answer:
      'Solano County experiences hot, dry summers with Delta breezes and mild, wet winters. Concrete pavers and natural stone are excellent choices — both are heat-resistant, freeze-thaw durable, and low-maintenance. We help you select materials that perform well in the North Bay climate for decades.',
  },
  {
    question: 'Do you offer a warranty on paver installations in Solano County?',
    answer:
      'Yes. Every paver installation across Solano County comes with our 10-year warranty covering both labor and materials. We stand behind our workmanship and use only premium-grade products from trusted manufacturers.',
  },
  {
  ...
  {
    question: 'Are pavers a good investment for Solano County homes?',
    answer:
      'Absolutely. Pavers increase curb appeal and property value in Solano County\'s growing real estate market. They\'re more durable than concrete, require less maintenance, and can be individually replaced if damaged. With our 10-year warranty, it\'s a smart investment for any homeowner.',
  },
];
...
const jsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      {
        '@type': 'Offer',
        itemOffered: { '@type': 'Service', name: 'Paver Driveway Installation', description: 'Custom interlocking paver driveways for Solano County homes.' },
      },
      {
        '@type': 'Offer',
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/P1.webp"
            alt="Professional paver installation in Solano County"
            fill
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving 7 Cities in Solano County
          </div>
          <h1 className="font-oswald text-[2rem] sm:text-[3rem] lg:text-[4.5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            PROFESSIONAL PAVER<br />INSTALLATION IN<br />SOLANO COUNTY
          </h1>
          <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed max-w-[700px] mx-auto">
            Serving 7 cities across Solano County.<br />
      ...
      <section className="hidden md:block py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            From the waterfront communities of Vallejo and Benicia to the growing neighborhoods of Vacaville and Fairfield, TP Pavers delivers expert paver installation across every corner of Solano County.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Paver Services Across Solano County
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            From elegant driveways in Benicia to functional retaining walls in the hills of Vallejo, we offer a full range of hardscape solutions tailored to Solano County homes.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Solano County, CA`}
                    fill
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Recent Projects in Solano County
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { src: '/images/projects/walkway-brick-curved.webp', alt: 'Curved brick paver walkway in Solano County' },
              ...
              { src: '/images/projects/team-working.webp', alt: 'TP Pavers team at work in Solano County' },
            ].map((photo, i) => (
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Solano County — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          ...
          <p className="text-white/70 mb-8 text-lg">
            Get a free on-site estimate anywhere in Solano County. No obligation, no pressure.
          </p>
          <a
            href="tel:+15106500080"
