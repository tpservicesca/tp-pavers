...
export const metadata: Metadata = {
  title: 'Paver Installation in Benicia, CA | TP Pavers',
  description:
    'Professional paver installation in Benicia, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Benicia neighborhoods including Southampton, Arsenal & Downtown.',
  keywords: [
    'pavers benicia',
    'benicia pavers',
    'paver installation benicia',
    'paver contractor benicia',
    'driveway pavers benicia ca',
    'patio pavers benicia',
    'benicia paver contractor',
    'pavers in benicia ca',
    'retaining wall benicia',
    'hardscape benicia ca',
    'paver driveway benicia california',
    'outdoor pavers benicia',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio benicia',
  ],
  openGraph: {
    title: 'Paver Installation in Benicia, CA | TP Pavers',
    description:
      'Expert paver installation in Benicia. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/benicia',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Benicia, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Benicia | TP Pavers',
    description: 'Expert paver installation in Benicia, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/benicia',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Benicia',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Benicia, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/benicia',
...
const services = [
  {
    ...
    description:
      'Upgrade your Benicia home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Southampton and the historic Arsenal district.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Benicia\'s charming waterfront lifestyle. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Benicia\'s hillside properties and sloped lots often require structural solutions. Our retaining walls prevent erosion, maximize usable space, and add stunning landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Benicia lawn green year-round. Our premium artificial turf is perfect for families, pets, and California\'s water-wise lifestyle.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Benicia, CA?',
    answer:
      'Paver installation costs in Benicia depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Benicia homeowners find excellent value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Benicia do you serve?',
    answer:
      'We serve all of Benicia including Southampton, the Arsenal, Downtown, East Side, and West Side neighborhoods. We also cover neighboring cities like Vallejo, Martinez, and Concord.',
  },
  {
    question: 'How long does a paver driveway installation take in Benicia?',
    answer:
      'Most residential paver projects in Benicia — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Benicia\'s climate?',
    answer:
      'Benicia enjoys a mild climate moderated by the Carquinez Strait breezes, making concrete pavers and natural stone excellent choices. Both materials are durable, low-maintenance, and hold up beautifully in the North Bay for decades.',
  },
  {
    question: 'Do you offer a warranty on Benicia paver installations?',
    answer:
      'Yes. Every paver installation in Benicia comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you work with Benicia\'s historic home styles?',
    answer:
      'Absolutely. Benicia has a rich architectural heritage, especially in the Downtown and Arsenal districts. We specialize in selecting paver patterns, colors, and materials that complement historic homes while meeting modern performance standards.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Benicia"
            afterAlt="Backyard after paver installation in Benicia - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Benicia, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN BENICIA
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Benicia Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Benicia is a historic waterfront gem on the Carquinez Strait — California&apos;s former state capital with tree-lined streets, charming downtown shops, and beautiful homes. From the stately properties of Southampton to the creative Arsenal district, we design hardscapes that honor Benicia&apos;s unique character.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Benicia, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Benicia Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Vallejo, Martinez, Concord &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Benicia — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Benicia Home?
          </h2>
