...
export const metadata: Metadata = {
  title: 'Paver Installation in Palo Alto, CA | TP Pavers',
  description:
    'Professional paver installation in Palo Alto, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Palo Alto neighborhoods.',
  keywords: [
    'pavers palo alto',
    'palo alto pavers',
    'paver installation palo alto',
    'paver contractor palo alto',
    'driveway pavers palo alto ca',
    'patio pavers palo alto',
    'palo alto paver contractor',
    'pavers in palo alto ca',
    'retaining wall palo alto',
    'hardscape palo alto ca',
    'paver driveway palo alto california',
    'outdoor pavers palo alto',
  ],
  openGraph: {
    title: 'Paver Installation in Palo Alto, CA | TP Pavers',
    description:
      'Expert paver installation in Palo Alto. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Palo Alto, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Palo Alto | TP Pavers',
    description: 'Expert paver installation in Palo Alto, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/palo-alto',
  },
};
...
const services = [
  {
    ...
    description:
      'Create a striking first impression on Palo Alto&apos;s tree-lined streets with a custom interlocking paver driveway. From the stately homes of Crescent Park to the craftsman bungalows of Professorville, we design driveways that elevate your curb appeal.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Palo Alto&apos;s Mediterranean climate is perfect for outdoor living. Our custom patios and walkways let you enjoy the sunshine year-round, from intimate garden paths in College Terrace to expansive entertaining spaces in Old Palo Alto.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Whether you&apos;re managing grade changes near the Foothills or adding landscape tiers in Barron Park, our retaining walls combine structural excellence with beautiful design to transform your outdoor space.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Join Palo Alto&apos;s sustainability movement with premium synthetic turf. Save thousands of gallons of water annually while maintaining a lush, green lawn that looks perfect in every season — ideal for tech-forward, eco-conscious homeowners.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Palo Alto, CA?',
    answer:
      'Paver installation costs in Palo Alto depend on project size, materials, and site preparation. Palo Alto homeowners often choose premium materials like natural stone or large-format pavers. We provide free on-site estimates with transparent, detailed pricing for every project.',
  },
  {
    question: 'What neighborhoods in Palo Alto do you serve?',
    answer:
      'We serve all of Palo Alto including Old Palo Alto, Crescent Park, Professorville, College Terrace, Barron Park, Midtown, Charleston Meadows, and every neighborhood in between. We also cover Menlo Park, Mountain View, Los Altos, and Stanford.',
  },
  {
    question: 'How long does a paver project take in Palo Alto?',
    answer:
      'Most residential paver projects in Palo Alto are completed in 1 to 2 weeks. We handle everything from permits to final sealing. A detailed timeline is provided during your free consultation, and we respect Palo Alto&apos;s construction scheduling guidelines.',
  },
  {
    question: 'Do you handle permits for paver work in Palo Alto?',
    answer:
      'Yes. We&apos;re familiar with Palo Alto&apos;s building requirements and handle any necessary permits. The city has specific guidelines for impervious surfaces and drainage, and we ensure every project meets or exceeds local standards.',
  },
  {
    question: 'Do you offer a warranty on Palo Alto paver installations?',
    answer:
      'Yes. Every paver installation in Palo Alto comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can pavers help with water drainage on my Palo Alto property?',
    answer:
      'Absolutely. Permeable pavers are an excellent choice for Palo Alto properties, allowing rainwater to filter through the surface naturally. This helps meet the city&apos;s stormwater management requirements while reducing runoff and protecting the environment.',
  },
];

const neighborhoods = ['Old Palo Alto', 'Crescent Park', 'Professorville', 'College Terrace', 'Barron Park', 'Midtown', 'Charleston Meadows'];

const zipCodes = ['94301', '94303', '94304', '94306'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Palo Alto"
            afterAlt="Backyard after paver installation in Palo Alto - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Palo Alto, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN PALO ALTO
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Palo Alto Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Palo Alto — the birthplace of Silicon Valley — is a world-class city where innovation meets timeless residential charm. From the historic Professorville district to the majestic oaks of Crescent Park, this Stanford University neighbor demands hardscapes of the highest caliber. We deliver craftsmanship that matches Palo Alto&apos;s exceptional standards.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Palo Alto, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Menlo Park, Mountain View, Los Altos, Stanford &amp; surrounding Peninsula areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Palo Alto — Common Questions
          </h2>
