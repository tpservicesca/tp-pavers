...
export const metadata: Metadata = {
  title: 'Paver Installation in San Ramon, CA | TP Pavers',
  description:
    'Professional paver installation in San Ramon, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving Dougherty Valley, Gale Ranch & all San Ramon neighborhoods.',
  keywords: [
    'pavers san ramon',
    'san ramon pavers',
    'paver installation san ramon',
    'paver contractor san ramon',
    'driveway pavers san ramon ca',
    'patio pavers san ramon',
    'san ramon paver contractor',
    'pavers in san ramon ca',
    'retaining wall san ramon',
    'hardscape san ramon ca',
  ...
  openGraph: {
    title: 'Paver Installation in San Ramon, CA | TP Pavers',
    description:
      'Expert paver installation in San Ramon. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/san-ramon',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in San Ramon, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in San Ramon | TP Pavers',
    description: 'Expert paver installation in San Ramon, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/san-ramon',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - San Ramon',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in San Ramon, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/san-ramon',
...
const services = [
  {
    ...
    description:
      'Upgrade your San Ramon home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in master-planned communities like Dougherty Valley and Gale Ranch.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for San Ramon\'s sunny climate. From backyard pavers near Bishop Ranch to elegant front walkways in Windemere, we create durable and beautiful hardscapes for every home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'San Ramon\'s hillside properties along the Iron Horse Trail and Crow Canyon corridors often require structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your San Ramon lawn green year-round. Our premium artificial turf is perfect for families, pets, and the warm East Bay climate — ideal for busy professionals in the Bishop Ranch area.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in San Ramon, CA?',
    answer:
      'Paver installation cost in San Ramon depends on project scope, materials selected, and site preparation. We provide free on-site estimates with transparent pricing. Most San Ramon homeowners in Dougherty Valley and Gale Ranch find our rates competitive for the quality we deliver.',
  },
  {
    question: 'What neighborhoods in San Ramon do you serve?',
    answer:
      'We serve all San Ramon neighborhoods including Dougherty Valley, Gale Ranch, Windemere, Canyon Lakes, Westside, Crow Canyon, Twin Creeks, and Bollinger Hills. We also cover nearby Dublin, Danville, Pleasanton, and Walnut Creek.',
  },
  {
    question: 'What patio paver designs are popular in San Ramon?',
    answer:
      'San Ramon homeowners love modern, clean-lined patio paver designs that complement their newer homes. Popular choices include large-format pavers, contemporary gray tones, and herringbone patterns. We offer a wide range of materials and patio paver designs to match any style.',
  },
  {
    question: 'Do you install driveway pavers near me in San Ramon?',
    answer:
      'Yes! We are a local paver contractor serving all of San Ramon and the Tri-Valley. Whether you need driveway pavers, backyard pavers, or walkway installation, our team provides free estimates throughout the San Ramon area.',
  },
  {
    question: 'What warranty do you offer on San Ramon paver projects?',
    answer:
      'Every paver installation in San Ramon comes with our 10-year warranty covering labor and materials. We use premium-grade products and proper base preparation to ensure your pavers last decades in the East Bay climate.',
  },
  {
    question: 'Can you work with new construction homes in San Ramon?',
    answer:
      'Absolutely. Many new developments in Dougherty Valley and Gale Ranch come with basic landscaping. We specialize in upgrading these yards with custom pavers patio areas, driveways, and walkways that dramatically improve your outdoor living space.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in San Ramon"
            afterAlt="Backyard after paver installation in San Ramon - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving San Ramon, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN SAN RAMON
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why San Ramon Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            San Ramon is one of the Tri-Valley&apos;s most family-oriented cities — known for master-planned communities, the Bishop Ranch business park, and miles of Iron Horse Trail. From the newer homes in Dougherty Valley to the established neighborhoods of Crow Canyon, we design hardscapes that elevate your outdoor living.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in San Ramon, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Dublin, Danville, Pleasanton, Walnut Creek &amp; surrounding Tri-Valley areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in San Ramon — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your San Ramon Home?
          </h2>
          <p className="text-white/70 mb-8 text-lg">
            Get a free on-site estimate today. No obligation, no pressure — serving all San Ramon communities.
          </p>
          <a
            href="tel:+15106500080"
