...
export const metadata: Metadata = {
  ...
  description:
    'Professional paver installation across 8+ cities in Santa Clara County. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience, 10-year warranty. Serving San Jose, Sunnyvale, Cupertino, Mountain View & more. Call (510) 650-2083.',
  keywords: [
