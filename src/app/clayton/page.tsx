...
export const metadata: Metadata = {
  title: 'Paver Installation in Clayton, CA | TP Pavers',
  description:
    'Professional paver installation in Clayton, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Clayton neighborhoods.',
  keywords: [
    'pavers clayton',
    'clayton pavers',
    'paver installation clayton',
    'paver contractor clayton',
    'driveway pavers clayton ca',
    'patio pavers clayton',
    'clayton paver contractor',
    'pavers in clayton ca',
    'retaining wall clayton',
    'hardscape clayton ca',
    'paver driveway clayton california',
    'outdoor pavers clayton',
  ],
  openGraph: {
    title: 'Paver Installation in Clayton, CA | TP Pavers',
    description:
      'Expert paver installation in Clayton. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/clayton',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Clayton, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Clayton | TP Pavers',
    description: 'Expert paver installation in Clayton, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/clayton',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Clayton',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Clayton, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/clayton',
...
const services = [
  {
    ...
    description:
      'Upgrade your Clayton home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Oakhurst and Clayton Valley.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Clayton\'s charming downtown and scenic foothill properties. From backyard pavers to front walkways, we create durable patio paver designs for every Clayton home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Clayton\'s terrain near the sloped terrain at the base of Mount Diablo often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Clayton lawn green year-round. Our premium artificial turf is perfect for families, pets, and Clayton\'s Mediterranean climate with warm summers moderated by mountain breezes.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in Clayton, CA?',
    answer:
      'Paver installation cost in Clayton depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Clayton homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Clayton do you serve?',
    answer:
      'We serve all of Clayton including Oakhurst, Clayton Valley, Mt. Diablo foothills. We also cover neighboring cities like Concord, Walnut Creek, Pleasant Hill and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Clayton?',
    answer:
      'Most residential paver projects in Clayton — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Clayton\'s climate?',
    answer:
      'Clayton\'s Mediterranean climate with warm summers moderated by mountain breezes makes concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the Contra Costa County climate.',
  },
  {
    question: 'Do you offer a warranty on Clayton paver installations?',
    answer:
      'Yes. Every paver installation in Clayton comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Clayton?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially with Clayton\'s rocky foothill soil near Mt. Diablo.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Clayton"
            afterAlt="Backyard after paver installation in Clayton - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Clayton, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN CLAYTON
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Clayton Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Clayton is a picturesque small town nestled at the base of Mount Diablo. Whether you\'re looking for driveway pavers near me or exploring patio paver designs, we create hardscapes that match your home and lifestyle — from Oakhurst to Clayton Valley.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Clayton, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Concord, Walnut Creek &amp; Pleasant Hill &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Clayton — Common Questions
          </h2>
