...
export const metadata: Metadata = {
  title: 'Paver Installation in Emeryville, CA | TP Pavers',
  description:
    'Professional paver installation in Emeryville, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Emeryville neighborhoods.',
  keywords: [
    'pavers emeryville',
    'emeryville pavers',
    'paver installation emeryville',
    'paver contractor emeryville',
    'driveway pavers emeryville ca',
    'patio pavers emeryville',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers emeryville',
    'retaining wall emeryville',
    'hardscape emeryville ca',
  ],
  openGraph: {
    title: 'Paver Installation in Emeryville, CA | TP Pavers',
    description:
      'Expert paver installation in Emeryville. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/emeryville',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Emeryville, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Emeryville | TP Pavers',
    description: 'Expert paver installation in Emeryville, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/emeryville',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Emeryville',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Emeryville, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/emeryville',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'We serve all of Emeryville including the Triangle, Doyle-Hollis, Park Avenue, and the Bay Street area. We also cover neighboring cities like Oakland, Berkeley, and Albany.',
  },
  {
    question: 'How long does a paver driveway installation take in Emeryville?',
    answer:
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Emeryville"
            afterAlt="Backyard after paver installation in Emeryville - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Emeryville, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN EMERYVILLE
          </h1>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Emeryville, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Emeryville Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Oakland, Berkeley, Albany &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Emeryville — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Emeryville Home?
          </h2>
