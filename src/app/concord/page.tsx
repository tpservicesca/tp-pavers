...
export const metadata: Metadata = {
  title: 'Paver Installation in Concord, CA | TP Pavers',
  description:
    'Professional paver installation in Concord, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Concord neighborhoods.',
  keywords: [
    'pavers concord',
    'concord pavers',
    'paver installation concord',
    'paver contractor concord',
    'driveway pavers concord ca',
    'patio pavers concord',
    'concord paver contractor',
    'pavers in concord ca',
    'retaining wall concord',
    'hardscape concord ca',
    'paver driveway concord california',
    'outdoor pavers concord',
  ],
  openGraph: {
    title: 'Paver Installation in Concord, CA | TP Pavers',
    description:
      'Expert paver installation in Concord. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/concord',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Concord, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Concord | TP Pavers',
    description: 'Expert paver installation in Concord, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/concord',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Concord',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Concord, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/concord',
...
const services = [
  ...
  },
  {
    ...
    description:
      'Save water and keep your Concord lawn green year-round. Our premium artificial turf is perfect for families, pets, and the Contra Costa climate.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Concord, CA?',
    answer:
      'Paver installation costs in Concord depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Concord homeowners are pleasantly surprised by the value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Concord do you serve?',
    answer:
      'We serve all of Concord including Dana Estates, Todos Santos, Ellis, Sun Terrace, Crystal Ranch, Meadow Homes, Lime Ridge, and the areas near Concord BART. We also cover neighboring cities like Walnut Creek, Pleasant Hill, Martinez, and Clayton.',
  },
  {
    question: 'How long does a paver driveway installation take in Concord?',
    answer:
      'Most residential paver projects in Concord — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Concord\'s climate?',
    answer:
      'Concord experiences hot summers and mild winters, making concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the East Bay climate.',
  },
  {
    question: 'Do you offer a warranty on Concord paver installations?',
    answer:
      'Yes. Every paver installation in Concord comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Concord?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially on Concord\'s clay-heavy soil.',
  },
];
...
const zipCodes = ['94518', '94519', '94520', '94521'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Concord"
            afterAlt="Backyard after paver installation in Concord - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Concord, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN CONCORD
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Concord Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Concord is the heart of Contra Costa County — a growing city with diverse neighborhoods, warm summers, and homeowners who take pride in their properties. From the family-friendly streets of Crystal Ranch to the established charm of Todos Santos Plaza, we design hardscapes that match your home and lifestyle.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Concord, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Walnut Creek, Pleasant Hill, Martinez, Clayton, Pittsburg &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Concord — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Concord Home?
          </h2>
