...
export const metadata: Metadata = {
  title: 'Paver Installation in Daly City, CA | TP Pavers',
  description:
    'Professional paver installation in Daly City, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Daly City neighborhoods.',
  keywords: [
      "pavers daly city",
      "daly city pavers",
      "paver installation daly city",
      "paver contractor daly city",
      "driveway pavers daly city ca",
      "patio pavers daly city",
      "daly city paver contractor",
      "pavers in daly city ca",
      "retaining wall daly city",
      "hardscape daly city ca",
      "paver driveway daly city california",
      "outdoor pavers daly city"
  ],
  openGraph: {
    title: 'Paver Installation in Daly City, CA | TP Pavers',
    description:
      'Expert paver installation in Daly City. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/daly-city',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Daly City, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Daly City | TP Pavers',
    description: 'Expert paver installation in Daly City, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/daly-city',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Daly City',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Daly City, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/daly-city',
...
const services = [
  {
    ...
    description:
      "Upgrade your Daly City home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Westlake and Serramonte.",
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      "Design the perfect outdoor living space for Daly City\'s beautiful weather. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.",
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      "Daly City\'s varied terrain often requires structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to properties throughout Bayshore and beyond.",
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      "Save water and keep your Daly City lawn green year-round. Our premium artificial turf is perfect for families, pets, and California\'s drought-conscious lifestyle.",
  },
];

const faqs = [
  {
    question: "How much do pavers cost in Daly City, CA?",
    answer:
      "Paver installation costs in Daly City depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Daly City homeowners are pleasantly surprised by the value compared to plain concrete.",
  },
  {
    question: "What neighborhoods in Daly City do you serve?",
    answer:
      "We serve all of Daly City including Westlake, Serramonte, Bayshore, Broadmoor Village, St. Francis Heights. We also cover neighboring cities throughout San Mateo County.",
  },
  {
    question: "How long does a paver driveway installation take in Daly City?",
    answer:
      "Most residential paver projects in Daly City — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.",
  },
  {
    question: "What paver materials work best for Daly City\'s climate?",
    answer:
      "Daly City enjoys a mild Mediterranean climate, making concrete pavers and natural stone excellent choices. Both are durable, weather-resistant, and low-maintenance. We help you select materials that look great and last decades in the Bay Area climate.",
  },
  {
    question: "Do you offer a warranty on Daly City paver installations?",
    answer:
      "Yes. Every paver installation in Daly City comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in Daly City?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for Daly City properties.",
  }
];

const neighborhoods = ["Westlake","Serramonte","Bayshore","Broadmoor Village","St. Francis Heights"];

const zipCodes = ["94014","94015"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Daly City"
            afterAlt="Backyard after paver installation in Daly City - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Daly City, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN DALY CITY
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Daly City Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Daly City is the gateway to the Peninsula — a diverse, bustling city bordering San Francisco with unique microclimates and a strong sense of community. From the planned streets of Westlake to the hilltop views of St. Francis Heights, we build hardscapes that stand up to the coastal weather.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Daly City, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: South San Francisco, Pacifica, Colma, Brisbane & surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Daly City — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Daly City Home?
          </h2>
