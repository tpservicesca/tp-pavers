...
export const metadata: Metadata = {
  title: 'Paver Installation in Martinez, CA | TP Pavers',
  description:
    'Professional paver installation in Martinez, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Martinez neighborhoods.',
  keywords: [
    'pavers martinez',
    'martinez pavers',
    'paver installation martinez',
    'paver contractor martinez',
    'driveway pavers martinez ca',
    'patio pavers martinez',
    'martinez paver contractor',
    'pavers in martinez ca',
    'retaining wall martinez',
    'hardscape martinez ca',
    'paver driveway martinez california',
    'outdoor pavers martinez',
  ],
  openGraph: {
    title: 'Paver Installation in Martinez, CA | TP Pavers',
    description:
      'Expert paver installation in Martinez. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/martinez',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Martinez, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Martinez | TP Pavers',
    description: 'Expert paver installation in Martinez, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/martinez',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Martinez',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Martinez, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/martinez',
...
const services = [
  {
    ...
    description:
      'Upgrade your Martinez home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Downtown and Alhambra Valley.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Martinez\'s terrain near the rolling hills of Alhambra Valley and the Carquinez shoreline often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
...
const faqs = [
  {
    question: 'How much does paver installation cost in Martinez, CA?',
    answer:
      'Paver installation cost in Martinez depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Martinez homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Martinez do you serve?',
    answer:
      'We serve all of Martinez including Downtown, Alhambra Valley, Hidden Lakes, Pine Meadow, John Muir. We also cover neighboring cities like Concord, Pleasant Hill, Benicia, Hercules and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Martinez?',
    answer:
      'Most residential paver projects in Martinez — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Every paver installation in Martinez comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Martinez"
            afterAlt="Backyard after paver installation in Martinez - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Martinez, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN MARTINEZ
          </h1>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Martinez, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Concord, Pleasant Hill, Benicia &amp; Hercules &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Martinez — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Martinez Home?
          </h2>
