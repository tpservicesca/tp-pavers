...
export const metadata: Metadata = {
  title: 'Paver Installation in Bay Point, CA | TP Pavers',
  description:
    'Professional paver installation in Bay Point, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Bay Point neighborhoods.',
  keywords: [
    'pavers bay point',
    'bay point pavers',
    'paver installation bay point',
    'paver contractor bay point',
    'driveway pavers bay point ca',
    'patio pavers bay point',
    'bay point paver contractor',
    'pavers in bay point ca',
    'retaining wall bay point',
    'hardscape bay point ca',
    'paver driveway bay point california',
    'outdoor pavers bay point',
  ],
  openGraph: {
    title: 'Paver Installation in Bay Point, CA | TP Pavers',
    description:
      'Expert paver installation in Bay Point. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/bay-point',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Bay Point, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Bay Point | TP Pavers',
    description: 'Expert paver installation in Bay Point, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/bay-point',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Bay Point',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Bay Point, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/bay-point',
...
const services = [
  {
    ...
    description:
      'Upgrade your Bay Point home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Shore Acres and Bella Vista.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Bay Point\'s terrain near the flat to gently rolling terrain near the Suisun Bay shoreline often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
...
const faqs = [
  {
    question: 'How much does paver installation cost in Bay Point, CA?',
    answer:
      'Paver installation cost in Bay Point depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Bay Point homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Bay Point do you serve?',
    answer:
      'We serve all of Bay Point including Shore Acres, Bella Vista, Rio Vista, Bailey. We also cover neighboring cities like Pittsburg, Concord, Pacheco, Martinez and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Bay Point?',
    answer:
      'Most residential paver projects in Bay Point — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Every paver installation in Bay Point comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Bay Point"
            afterAlt="Backyard after paver installation in Bay Point - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Bay Point, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN BAY POINT
          </h1>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Bay Point, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Pittsburg, Concord, Pacheco &amp; Martinez &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Bay Point — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Bay Point Home?
          </h2>
