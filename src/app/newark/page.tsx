...
export const metadata: Metadata = {
  title: 'Paver Installation in Newark, CA | TP Pavers',
  description:
    'Professional paver installation in Newark, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Newark neighborhoods.',
  keywords: [
    'pavers newark',
    'newark pavers',
    'paver installation newark',
    'paver contractor newark',
    'driveway pavers newark ca',
    'patio pavers newark',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers newark',
    'retaining wall newark',
    'hardscape newark ca',
  ],
  openGraph: {
    title: 'Paver Installation in Newark, CA | TP Pavers',
    description:
      'Expert paver installation in Newark. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/newark',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Newark, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Newark | TP Pavers',
    description: 'Expert paver installation in Newark, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/newark',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Newark',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Newark, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/newark',
...
const services = [
  {
    ...
    description:
      'Upgrade your Newark home with a custom interlocking paver driveway. From the charming streets of Old Town to the newer developments near Newark Meadows, our driveways add lasting beauty and enhance your home\'s curb appeal.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Newark\'s sunny climate. Whether you\'re near Birch Grove or Lakeshore, we create beautiful patios and walkways that extend your living space and are perfect for family gatherings.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Newark properties benefit from well-designed retaining walls that define spaces, add garden tiers, and enhance landscape beauty. We build structural and decorative walls that complement your home and outdoor living areas.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Newark lawn green year-round. Our premium artificial turf is ideal for families and pets across Newark, from Heritage Park to Stevenson Park neighborhoods — a smart choice for water-conscious California living.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Newark, CA?',
    answer:
      'Paver installation costs in Newark depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway in Old Town or a patio near Lakeshore, we provide free on-site estimates with transparent pricing. Most Newark homeowners find pavers an excellent investment in their property.',
  },
  {
    question: 'What neighborhoods in Newark do you serve?',
    answer:
      'We serve all of Newark including Old Town, Birch Grove, Lakeshore, Stevenson Park, Heritage Park, and Newark Meadows. We also cover neighboring cities like Fremont, Union City, Menlo Park, and East Palo Alto.',
  },
  {
    question: 'How long does a paver patio installation take in Newark?',
    answer:
      'Most residential paver projects in Newark — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Newark\'s climate?',
    answer:
      'Newark enjoys warm summers and mild winters, making concrete pavers and natural stone excellent choices. Both are durable, heat-resistant, and low-maintenance — perfect for the South Bay climate. We help you select materials that suit your style and budget.',
  },
  {
    question: 'Do you offer a warranty on Newark paver installations?',
    answer:
      'Yes. Every paver installation in Newark comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Newark?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation ensures a long-lasting installation, and we deliver beautiful results for every Newark homeowner.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Newark"
            afterAlt="Backyard after paver installation in Newark - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Newark, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN NEWARK
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Newark Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Newark is a close-knit community with a small-town feel and convenient East Bay location. From the established homes of Old Town to the family-friendly neighborhoods near Heritage Park, we design hardscapes that enhance your property and create inviting outdoor living spaces.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Newark, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Fremont, Union City, Menlo Park, East Palo Alto &amp; surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Newark — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Newark Home?
          </h2>
