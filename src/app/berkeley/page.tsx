...
export const metadata: Metadata = {
  title: 'Paver Installation in Berkeley, CA | TP Pavers',
  description:
    'Professional paver installation in Berkeley, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Berkeley neighborhoods.',
  keywords: [
    'pavers berkeley',
    'berkeley pavers',
    'paver installation berkeley',
    'paver contractor berkeley',
    'driveway pavers berkeley ca',
    'patio pavers berkeley',
    'paver installation near me',
    'driveway pavers near me',
    'pavers patio',
    'backyard pavers berkeley',
    'retaining wall berkeley',
    'hardscape berkeley ca',
  ],
  openGraph: {
    title: 'Paver Installation in Berkeley, CA | TP Pavers',
    description:
      'Expert paver installation in Berkeley. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/berkeley',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Berkeley, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Berkeley | TP Pavers',
    description: 'Expert paver installation in Berkeley, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/berkeley',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Berkeley',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Berkeley, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/berkeley',
...
const services = [
  {
    ...
    description:
      'Upgrade your Berkeley home with a custom interlocking paver driveway. From the classic homes of Elmwood to the hillside properties of Claremont, our driveways are designed to enhance curb appeal and withstand daily use.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Create the perfect outdoor entertaining space for Berkeley\'s mild climate. Whether you\'re near the Gourmet Ghetto or in North Berkeley, we build beautiful patios and walkways that extend your living space outdoors.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Berkeley\'s hilly terrain in neighborhoods like Berkeley Hills and Claremont often requires expert retaining wall solutions. We build structural walls that prevent erosion and create beautiful tiered landscapes.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and enjoy a lush green lawn year-round in Berkeley. Our premium artificial turf is eco-friendly and low-maintenance — perfect for environmentally conscious Berkeley homeowners and families.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Berkeley, CA?',
    answer:
      'Paver installation costs in Berkeley depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway in Elmwood or a patio in Thousand Oaks, we provide free on-site estimates with transparent pricing. Most Berkeley homeowners find pavers offer excellent value and lasting beauty.',
  },
  {
    question: 'What neighborhoods in Berkeley do you serve?',
    answer:
      'We serve all of Berkeley including North Berkeley, Elmwood, Claremont, Thousand Oaks, Westbrae, Gourmet Ghetto, South Berkeley, and Berkeley Hills. We also cover neighboring cities like Oakland, Albany, El Cerrito, and Kensington.',
  },
  {
    question: 'How long does a paver patio installation take in Berkeley?',
    answer:
      'Most residential paver projects in Berkeley — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Every paver installation in Berkeley comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for every project.',
  },
  {
    question: 'Can you install permeable pavers in Berkeley?',
    answer:
      'Yes, we install permeable paver systems that allow rainwater to filter through naturally. This is an excellent choice for environmentally conscious Berkeley homeowners looking to reduce runoff and comply with stormwater management guidelines.',
  },
];
...
const zipCodes = ['94702', '94703', '94704', '94705', '94706', '94707', '94708', '94709', '94710'];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Berkeley"
            afterAlt="Backyard after paver installation in Berkeley - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Berkeley, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN BERKELEY
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Berkeley Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Berkeley is a city that values craftsmanship, sustainability, and beautiful design. From the charming Craftsman homes of Elmwood to the scenic properties in the Berkeley Hills, we create hardscapes that honor your home\'s character while enhancing outdoor living.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Berkeley, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Oakland, Albany, El Cerrito, Kensington &amp; surrounding East Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Berkeley — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Berkeley Home?
          </h2>
