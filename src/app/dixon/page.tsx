...
export const metadata: Metadata = {
  title: 'Paver Installation in Dixon, CA | TP Pavers',
  description:
    'Professional paver installation in Dixon, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving Downtown, Southwest Dixon, Northeast Dixon & Homestead neighborhoods.',
  keywords: [
    'pavers dixon',
    'dixon pavers',
    'paver installation dixon',
    'paver contractor dixon',
    'driveway pavers dixon ca',
    'patio pavers dixon',
    'dixon paver contractor',
    'pavers in dixon ca',
    'retaining wall dixon',
    'hardscape dixon ca',
    'paver driveway dixon california',
    'outdoor pavers dixon',
    'paver installation near me',
    'driveway pavers near me',
    'backyard pavers dixon',
  ],
  openGraph: {
    title: 'Paver Installation in Dixon, CA | TP Pavers',
    description:
      'Expert paver installation in Dixon. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/dixon',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Dixon, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Dixon | TP Pavers',
    description: 'Expert paver installation in Dixon, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/dixon',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Dixon',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Dixon, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/dixon',
...
const services = [
  {
    ...
    description:
      'Upgrade your Dixon home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in the Homestead area, Downtown, and the newest Dixon developments.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Dixon\'s warm Central Valley summers. From backyard patios to front walkways, we create durable and beautiful hardscapes ideal for entertaining.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Whether you need to create landscape tiers or manage grading on your Dixon property, our retaining walls provide structural integrity and stunning visual appeal.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Dixon lawn green year-round. Our premium artificial turf is perfect for families, pets, and Dixon\'s hot summers — no mowing, no watering.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Dixon, CA?',
    answer:
      'Paver installation costs in Dixon depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Dixon homeowners are pleasantly surprised by the value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Dixon do you serve?',
    answer:
      'We serve all of Dixon including Downtown, Southwest Dixon, Northeast Dixon, and the Homestead area. We also cover neighboring cities like Vacaville, Davis, and Woodland.',
  },
  {
    question: 'How long does a paver driveway installation take in Dixon?',
    answer:
      'Most residential paver projects in Dixon — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Dixon\'s climate?',
    answer:
      'Dixon experiences hot, dry summers and cool winters typical of the Sacramento Valley edge. Concrete pavers and natural stone are excellent choices — both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades.',
  },
  {
    question: 'Do you offer a warranty on Dixon paver installations?',
    answer:
      'Yes. Every paver installation in Dixon comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Is Dixon too far for your service area?',
    answer:
      'Not at all! Dixon is an important part of our Solano County service area. We regularly work in Dixon and surrounding communities. Our team knows the local soil conditions and building requirements well.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Dixon"
            afterAlt="Backyard after paver installation in Dixon - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Dixon, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN DIXON
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Dixon Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Dixon is a charming small-town community with a big heart — known for its annual May Fair, friendly neighbors, and growing residential developments. From the established homes near Downtown to the newer Homestead neighborhood, we design hardscapes that add lasting value and curb appeal to every Dixon home.
          </p>
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Vacaville, Davis, Woodland &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Dixon — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Dixon Home?
          </h2>
