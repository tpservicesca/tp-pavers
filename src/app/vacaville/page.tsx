...
export const metadata: Metadata = {
  title: 'Paver Installation in Vacaville, CA | TP Pavers',
  description:
    'Professional paver installation in Vacaville, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving Southtown, Leisure Town, Brown\'s Valley & all Vacaville neighborhoods.',
  keywords: [
    'pavers vacaville',
    'vacaville pavers',
    'paver installation vacaville',
    'paver contractor vacaville',
    'driveway pavers vacaville ca',
    'patio pavers vacaville',
    'vacaville paver contractor',
    'pavers in vacaville ca',
    'retaining wall vacaville',
    'hardscape vacaville ca',
    'paver driveway vacaville california',
    'outdoor pavers vacaville',
    'paver installation near me',
    'driveway pavers near me',
    'backyard pavers vacaville',
  ],
  openGraph: {
    title: 'Paver Installation in Vacaville, CA | TP Pavers',
    description:
      'Expert paver installation in Vacaville. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/vacaville',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Vacaville, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Vacaville | TP Pavers',
    description: 'Expert paver installation in Vacaville, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/vacaville',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Vacaville',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Vacaville, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/vacaville',
...
const services = [
  {
    ...
    description:
      'Upgrade your Vacaville home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Brown\'s Valley and Alamo Creek.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Vacaville\'s warm summers. From backyard patios in Meadowlands to front walkways in Southtown, we create durable and beautiful hardscapes.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Vacaville\'s hillside areas and sloped properties near Brown\'s Valley often require structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Vacaville lawn green year-round. Our premium artificial turf is perfect for families, pets, and the hot Central Valley summers.',
  },
];

const faqs = [
  {
    question: 'How much do pavers cost in Vacaville, CA?',
    answer:
      'Paver installation costs in Vacaville depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Vacaville homeowners are pleasantly surprised by the value compared to plain concrete.',
  },
  {
    question: 'What neighborhoods in Vacaville do you serve?',
    answer:
      'We serve all of Vacaville including Southtown, Leisure Town, Brown\'s Valley, Alamo Creek, and Meadowlands. We also cover neighboring cities like Fairfield, Dixon, and Davis.',
  },
  {
    question: 'How long does a paver driveway installation take in Vacaville?',
    answer:
      'Most residential paver projects in Vacaville — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Vacaville\'s climate?',
    answer:
      'Vacaville experiences hot summers that can reach over 100°F and mild winters, making concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance — ideal for Vacaville\'s warm Solano County climate.',
  },
  {
    question: 'Do you offer a warranty on Vacaville paver installations?',
    answer:
      'Yes. Every paver installation in Vacaville comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Vacaville?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we ensure proper drainage for Vacaville\'s clay and loam soil conditions.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Vacaville"
            afterAlt="Backyard after paver installation in Vacaville - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Vacaville, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN VACAVILLE
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Vacaville Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Vacaville is one of Solano County&apos;s fastest-growing cities — known for its family-friendly neighborhoods, premium outlets, and easy commute to Sacramento and the Bay Area. From the scenic homes of Brown&apos;s Valley to the newer developments near Alamo Creek, we design hardscapes that add value and beauty to every property.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Vacaville, CA`}
                    fill
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Vacaville Neighborhoods We Serve
          </h2>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Fairfield, Dixon, Davis &amp; surrounding Solano County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Vacaville — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Vacaville Home?
          </h2>
