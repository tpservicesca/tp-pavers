...
export const metadata: Metadata = {
  title: 'Paver Installation in Burlingame, CA | TP Pavers',
  description:
    'Professional paver installation in Burlingame, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Burlingame neighborhoods.',
  keywords: [
      "pavers burlingame",
      "burlingame pavers",
      "paver installation burlingame",
      "paver contractor burlingame",
      "driveway pavers burlingame ca",
      "patio pavers burlingame",
      "burlingame paver contractor",
      "pavers in burlingame ca",
      "retaining wall burlingame",
      "hardscape burlingame ca",
      "paver driveway burlingame california",
      "outdoor pavers burlingame"
  ],
  openGraph: {
    title: 'Paver Installation in Burlingame, CA | TP Pavers',
    description:
      'Expert paver installation in Burlingame. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/burlingame',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Burlingame, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Burlingame | TP Pavers',
    description: 'Expert paver installation in Burlingame, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/burlingame',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Burlingame',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Burlingame, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/burlingame',
...
const services = [
  {
    ...
    description:
      "Upgrade your Burlingame home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Burlingame Hills and Broadway.",
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      "Design the perfect outdoor living space for Burlingame\'s beautiful weather. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.",
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      "Burlingame\'s varied terrain often requires structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to properties throughout Easton Addition and beyond.",
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      "Save water and keep your Burlingame lawn green year-round. Our premium artificial turf is perfect for families, pets, and California\'s drought-conscious lifestyle.",
  },
];

const faqs = [
  {
    question: "How much do pavers cost in Burlingame, CA?",
    answer:
      "Paver installation costs in Burlingame depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Burlingame homeowners are pleasantly surprised by the value compared to plain concrete.",
  },
  {
    question: "What neighborhoods in Burlingame do you serve?",
    answer:
      "We serve all of Burlingame including Burlingame Hills, Broadway, Easton Addition, Ray Park, Lyon-Hoag. We also cover neighboring cities throughout San Mateo County.",
  },
  {
    question: "How long does a paver driveway installation take in Burlingame?",
    answer:
      "Most residential paver projects in Burlingame — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.",
  },
  {
    question: "What paver materials work best for Burlingame\'s climate?",
    answer:
      "Burlingame enjoys a mild Mediterranean climate, making concrete pavers and natural stone excellent choices. Both are durable, weather-resistant, and low-maintenance. We help you select materials that look great and last decades in the Bay Area climate.",
  },
  {
    question: "Do you offer a warranty on Burlingame paver installations?",
    answer:
      "Yes. Every paver installation in Burlingame comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in Burlingame?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for Burlingame properties.",
  }
];

const neighborhoods = ["Burlingame Hills","Broadway","Easton Addition","Ray Park","Lyon-Hoag"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Burlingame"
            afterAlt="Backyard after paver installation in Burlingame - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Burlingame, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN BURLINGAME
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Burlingame Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Burlingame — the 'City of Trees' — is one of the Peninsula\'s most sought-after communities, known for its charming downtown, beautiful tree-lined avenues, and elegant homes. From the grand properties of Burlingame Hills to the classic bungalows of Easton Addition, we design hardscapes worthy of this distinguished neighborhood.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Burlingame, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: San Mateo, Hillsborough, Millbrae, San Bruno & surrounding Peninsula areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Burlingame — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Burlingame Home?
          </h2>
