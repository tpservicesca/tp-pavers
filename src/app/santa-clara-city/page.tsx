...
export const metadata: Metadata = {
  title: 'Paver Installation in Santa Clara, CA | TP Pavers',
  description:
    'Professional paver installation in Santa Clara, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Santa Clara neighborhoods.',
  keywords: [
      "pavers santa clara",
      "santa clara pavers",
      "paver installation santa clara",
      "paver contractor santa clara",
      "driveway pavers santa clara ca",
      "patio pavers santa clara",
      "santa clara paver contractor",
      "pavers in santa clara ca",
      "retaining wall santa clara",
      "hardscape santa clara ca",
      "paver driveway santa clara california",
      "outdoor pavers santa clara"
  ],
  openGraph: {
    title: 'Paver Installation in Santa Clara, CA | TP Pavers',
    description:
      'Expert paver installation in Santa Clara. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    url: 'https://tppavers.com/santa-clara-city',
    siteName: 'TP Pavers',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Santa Clara, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Santa Clara | TP Pavers',
    description: 'Expert paver installation in Santa Clara, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/santa-clara-city',
  },
};
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  name: 'TP Pavers - Santa Clara',
  description:
    'Professional paver installation, retaining walls, hardscape design and synthetic turf in Santa Clara, California. 20+ years experience with 10-year warranty.',
  url: 'https://tppavers.com/santa-clara-city',
...
const services = [
  {
    ...
    description:
      "Upgrade your Santa Clara home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Old Quad and Washington Park.",
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      "Design the perfect outdoor living space for Santa Clara\'s beautiful weather. From backyard patios to front walkways, we create durable and beautiful hardscapes for every home.",
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      "Santa Clara\'s varied terrain often requires structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to properties throughout University Park and beyond.",
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      "Save water and keep your Santa Clara lawn green year-round. Our premium artificial turf is perfect for families, pets, and California\'s drought-conscious lifestyle.",
  },
];

const faqs = [
  {
    question: "How much do pavers cost in Santa Clara, CA?",
    answer:
      "Paver installation costs in Santa Clara depend on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Santa Clara homeowners are pleasantly surprised by the value compared to plain concrete.",
  },
  {
    question: "What neighborhoods in Santa Clara do you serve?",
    answer:
      "We serve all of Santa Clara including Old Quad, Washington Park, University Park, Rivermark. We also cover neighboring cities throughout Santa Clara County.",
  },
  {
    question: "How long does a paver driveway installation take in Santa Clara?",
    answer:
      "Most residential paver projects in Santa Clara — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.",
  },
  {
    question: "What paver materials work best for Santa Clara\'s climate?",
    answer:
      "Santa Clara enjoys a mild Mediterranean climate, making concrete pavers and natural stone excellent choices. Both are durable, weather-resistant, and low-maintenance. We help you select materials that look great and last decades in the Bay Area climate.",
  },
  {
    question: "Do you offer a warranty on Santa Clara paver installations?",
    answer:
      "Yes. Every paver installation in Santa Clara comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products.",
  },
  {
    question: "Can you replace my old concrete driveway with pavers in Santa Clara?",
    answer:
      "Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially for Santa Clara properties.",
  }
];

const neighborhoods = ["Old Quad","Washington Park","University Park","Rivermark"];

const zipCodes = ["95050","95051","95052","95053","95054"];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Santa Clara"
            afterAlt="Backyard after paver installation in Santa Clara - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Santa Clara, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN SANTA CLARA
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Santa Clara Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Santa Clara — the 'Mission City' — blends Silicon Valley innovation with deep California history. From the tree-lined blocks of the Old Quad to the modern Rivermark community, homeowners here value quality craftsmanship. We install premium pavers that honor both the city\'s heritage and its forward-looking spirit.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Santa Clara, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: San Jose, Sunnyvale, Cupertino, Milpitas & surrounding South Bay areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Santa Clara — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Santa Clara Home?
          </h2>
