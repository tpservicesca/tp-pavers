...
export const metadata: Metadata = {
  title: 'Paver Installation in Orinda, CA | TP Pavers',
  description:
    'Professional paver installation in Orinda, California. Driveways, patios, walkways, retaining walls & synthetic turf. 20+ years experience. 10-year warranty. Free estimates. Serving all Orinda neighborhoods.',
  keywords: [
    'pavers orinda',
    'orinda pavers',
    'paver installation orinda',
    'paver contractor orinda',
    'driveway pavers orinda ca',
    'patio pavers orinda',
    'orinda paver contractor',
    'pavers in orinda ca',
    'retaining wall orinda',
    'hardscape orinda ca',
    'paver driveway orinda california',
    'outdoor pavers orinda',
  ],
  openGraph: {
    title: 'Paver Installation in Orinda, CA | TP Pavers',
    description:
      'Expert paver installation in Orinda. Driveways, patios, walkways & retaining walls. 20+ years experience. Free estimates.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Paver Installation in Orinda, California',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Paver Installation in Orinda | TP Pavers',
    description: 'Expert paver installation in Orinda, CA. Free estimates. 10-year warranty.',
    images: ['https://tppavers.com/images/P1.webp'],
  },
  alternates: {
    canonical: 'https://tppavers.com/orinda',
  },
};
...
const services = [
  {
    ...
    description:
      'Upgrade your Orinda home with a custom interlocking paver driveway. Built to handle daily traffic and enhance curb appeal in neighborhoods like Sleepy Hollow and Orinda Village.',
  },
  {
    image: '/images/projects/patio-raised-house.webp',
    title: 'Patios & Walkways',
    description:
      'Design the perfect outdoor living space for Orinda\'s prestigious estates, wooded hillsides, and scenic country club areas. From backyard pavers to front walkways, we create durable patio paver designs for every Orinda home.',
  },
  {
    image: '/images/projects/patio-retaining-wall.webp',
    title: 'Retaining Walls',
    description:
      'Orinda\'s terrain near the steep, wooded hillsides and scenic ravines of Orinda often benefits from structural solutions. Our retaining walls prevent erosion and add stunning landscape tiers to your property.',
  },
  {
    image: '/images/S1.webp',
    title: 'Synthetic Turf',
    description:
      'Save water and keep your Orinda lawn green year-round. Our premium artificial turf is perfect for families, pets, and Orinda\'s sheltered microclimate with warm summers and mild winters.',
  },
];

const faqs = [
  {
    question: 'How much does paver installation cost in Orinda, CA?',
    answer:
      'Paver installation cost in Orinda depends on the project size, materials chosen, and site preparation needed. Whether it\'s a driveway, patio, or walkway, we provide free on-site estimates with transparent pricing. Most Orinda homeowners find our rates competitive for the quality delivered.',
  },
  {
    question: 'What neighborhoods in Orinda do you serve?',
    answer:
      'We serve all of Orinda including Orinda Village, Glorietta, Sleepy Hollow, Orinda Country Club. We also cover neighboring cities like Lafayette, Moraga, Walnut Creek, Berkeley and surrounding East Bay areas.',
  },
  {
    question: 'How long does a paver driveway installation take in Orinda?',
    answer:
      'Most residential paver projects in Orinda — driveways, patios, or walkways — are completed in 1 to 2 weeks depending on size and complexity. We handle everything from demo to final sealing. A detailed timeline is provided after your free consultation.',
  },
  {
    question: 'What paver materials work best for Orinda\'s climate?',
    answer:
      'Orinda\'s sheltered microclimate with warm summers and mild winters makes concrete pavers and natural stone excellent choices. Both are heat-resistant, durable, and low-maintenance. We help you select materials that look great and last decades in the Contra Costa County climate.',
  },
  {
    question: 'Do you offer a warranty on Orinda paver installations?',
    answer:
      'Yes. Every paver installation in Orinda comes with our 10-year warranty covering both labor and materials. We stand behind the quality of our work and use only premium-grade products for driveway pavers, patio pavers, and walkways.',
  },
  {
    question: 'Can you replace my old concrete driveway with pavers in Orinda?',
    answer:
      'Absolutely. We handle full demolition and removal of existing concrete, asphalt, or old surfaces. Proper base preparation is key to a lasting install, and we never cut corners — especially with Orinda\'s steep hillside soil and clay composition.',
  },
];
    ...
    <>
      ...
      >
        <div className="absolute inset-0 z-0">
          <DynamicBeforeAfterSlider
            ...
            beforeAlt="Backyard before paver installation in Orinda"
            afterAlt="Backyard after paver installation in Orinda - beautiful patio"
          />
        </div>
        ...
        <div className="relative z-[2] text-center max-w-[900px] flex-grow flex flex-col justify-center items-center pointer-events-none">
          <div className="inline-flex items-center gap-2 bg-brand-orange/90 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
            <MapPin size={16} /> Serving Orinda, CA
          </div>
          <h1 className="font-oswald text-[2.2rem] sm:text-[3.5rem] lg:text-[5rem] font-bold text-white leading-[1.05] mb-5 uppercase tracking-[2px]">
            EXPERT PAVER<br />INSTALLATION<br />IN ORINDA
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-6 leading-[1.2]">
            Why Orinda Homeowners Trust TP Pavers
          </h2>
          <p className="text-slate-600 text-center max-w-[750px] mx-auto mb-12 leading-relaxed">
            Orinda is an exclusive Lamorinda community with stunning hillside properties and top-rated schools. Whether you\'re looking for driveway pavers near me or exploring patio paver designs, we create hardscapes that match your home and lifestyle — from Sleepy Hollow to Orinda Village.
          </p>
            ...
            {services.map((service, i) => (
              ...
              >
                <div className="relative h-[220px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} in Orinda, CA`}
                    fill
        ...
        <div className="max-w-[1100px] mx-auto px-5">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm">
              Also serving: Lafayette, Moraga, Walnut Creek &amp; Berkeley &amp; surrounding Contra Costa County areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-[900px] mx-auto px-5">
          ...
          <h2 className="text-[1.8rem] md:text-[2.4rem] font-bold text-brand-black text-center mb-10 leading-[1.2]">
            Paver Installation in Orinda — Common Questions
          </h2>
      ...
      <section className="py-16 bg-brand-black">
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-white mb-4">
            Ready to Transform Your Orinda Home?
          </h2>
